...
SELECT R.[Name], [Basic], [Overtime], [Deductions], [Transportation], [Basic] + [Transportation] AS [Gross Salary],
		...
		[Basic] + [Overtime] + [Deductions] + [Transportation] + [IncomeTax] + [PensionPayable] * 7.0/18 + 
