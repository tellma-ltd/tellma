...
WHEN NOT MATCHED BY TARGET THEN
    INSERT (
		...
		[Prefix], [CodeWidth], [AgentDefinitionList], [MainMenuIcon],		[MainMenuSection], [MainMenuSortKey]
	) VALUES (
		s.[Id], s.[IsOriginalDocument], s.[TitleSingular], s.[TitleSingular2], s.[TitleSingular3], s.[TitlePlural], s.[TitlePlural2], s.[TitlePlural3],
		s.[Prefix], s.[CodeWidth], s.[AgentDefinitionList], s.[MainMenuIcon], s.[MainMenuSection], s.[MainMenuSortKey]
	);
