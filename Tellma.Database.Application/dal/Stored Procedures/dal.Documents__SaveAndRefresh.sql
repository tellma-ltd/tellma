	...
	(
		...
		USING (
			SELECT 
				...
				[MemoIsCommon],
				[DebitContractId],
				[DebitContractIsCommon],
				[CreditContractId],
				[CreditContractIsCommon],
				[NotedContractId],
				[NotedContractIsCommon],
				[SegmentId],
				[SegmentIsCommon],
				[Time1],
				[Time1IsCommon],
		...
		WHEN MATCHED THEN
			UPDATE SET
				...
				t.[DebitContractId]			= s.[DebitContractId],
				t.[DebitContractIsCommon]	= s.[DebitContractIsCommon],
				t.[CreditContractId]		= s.[CreditContractId],
				t.[CreditContractIsCommon]	= s.[CreditContractIsCommon],
				t.[NotedContractId]			= s.[NotedContractId],
				t.[NotedContractIsCommon]	= s.[NotedContractIsCommon],
				t.[SegmentId]		= s.[SegmentId],
				t.[SegmentIsCommon]= s.[SegmentIsCommon],
				t.[Time1]					= s.[Time1],
		...
		WHEN NOT MATCHED THEN
			...
			VALUES (
				...
				s.[MemoIsCommon],
				s.[DebitContractId],
				s.[DebitContractIsCommon],
				s.[CreditContractId],
				s.[CreditContractIsCommon],
				s.[NotedContractId],
				s.[NotedContractIsCommon],
				s.[SegmentId],
				s.[SegmentIsCommon],
				s.[Time1],
				s.[Time1IsCommon],
