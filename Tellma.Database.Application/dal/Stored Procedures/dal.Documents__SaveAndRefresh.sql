	...
	(
		...
		WHEN MATCHED THEN
			UPDATE SET
				...
				t.[DebitAgentId]			= s.[DebitAgentId],
				t.[DebitAgentIsCommon]		= s.[DebitAgentIsCommon],
				t.[CreditAgentId]			= s.[CreditAgentId],
				t.[CreditAgentIsCommon]		= s.[CreditAgentIsCommon],
		...
		WHEN NOT MATCHED THEN
			...
			VALUES (
				...
				s.[MemoIsCommon],
				s.[DebitAgentId],
				s.[DebitAgentIsCommon],
				s.[CreditAgentId],
				s.[CreditAgentIsCommon],
				s.[NotedAgentId],
