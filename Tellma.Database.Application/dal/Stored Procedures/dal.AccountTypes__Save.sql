...
SET NOCOUNT ON;
	...
	(
		...
		USING (
			SELECT
				E.[Index], E.[Id], E.[ParentId],[IfrsConceptId],
				...
				E.[CurrencyAssignment],
				E.[AgentAssignment],
				E.[AgentDefinitionId],
				E.[ResourceAssignment],
				E.[ResourceDefinition],
				E.[CenterAssignment],
				E.[EntryTypeAssignment],
				E.[EntryTypeParentId],
				E.[IdentifierAssignment],
				E.[NotedAgentAssignment],
				E.[NotedAgentDefinition],
				E.[DueDateLabel],
				E.[DueDateLabel2],
				E.[DueDateLabel3],
				E.[Time1Label],
		...
		THEN
			UPDATE SET
				...
				t.[CurrencyAssignment]		= s.[CurrencyAssignment],
				t.[AgentAssignment]			= s.[AgentAssignment],
				t.[AgentDefinitionId]		= s.[AgentDefinitionId],
				t.[ResourceAssignment]		= s.[ResourceAssignment],
				t.[ResourceDefinition]		= s.[ResourceDefinition],
				t.[CenterAssignment]		= s.[CenterAssignment],
				t.[EntryTypeAssignment]		= s.[EntryTypeAssignment],
				t.[EntryTypeParentId]		= s.[EntryTypeParentId],
				t.[IdentifierAssignment]	= s.[IdentifierAssignment],
				t.[NotedAgentAssignment]	= s.[NotedAgentAssignment],
				t.[NotedAgentDefinition]	= s.[NotedAgentDefinition],
		...
		WHEN NOT MATCHED THEN
			...
			VALUES (s.[IfrsConceptId],
					...
					s.[Node],
					s.[IsAssignable],
					s.[CurrencyAssignment],
					s.[AgentAssignment],
					s.[AgentDefinitionId],
					s.[ResourceAssignment],
					s.[ResourceDefinition],
					s.[CenterAssignment],
					s.[EntryTypeAssignment],
					s.[EntryTypeParentId],
					s.[IdentifierAssignment],
					s.[NotedAgentAssignment],
					s.[NotedAgentDefinition],
					s.[DueDateLabel],
					s.[DueDateLabel2],
					s.[DueDateLabel3],
					s.[Time1Label],
