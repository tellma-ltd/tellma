CREATE FUNCTION [dal].[ft_Concept_Center_Agent_Resource__Balances_V2]
(-- This version excludes the current document
	...
	@CurrencyId NCHAR (3),
	@AsOf DATE,
	@DocumentsExcluded IdList READONLY
)
...
AS BEGIN
	...
	AND L.[DocumentId] NOT IN (SELECT [Id] FROM @DocumentsExcluded);
