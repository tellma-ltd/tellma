CREATE FUNCTION [dal].[fi_ParentAccountType__ChartAnomalies]
( --
...
(
	...
	AND	(AA1.[AgentDefinitionId] = AA2.[AgentDefinitionId] OR AA1.[AgentDefinitionId] IS NULL OR AA2.[AgentDefinitionId] IS NULL)
	AND (AA1.[ResourceDefinitionId] = AA2.[ResourceDefinitionId] OR AA1.[ResourceDefinitionId] IS NULL OR AA2.[ResourceDefinitionId] IS NULL)
	AND (AA1.[NotedAgentDefinitionId] = AA2.[NotedAgentDefinitionId] OR AA1.[NotedAgentDefinitionId] IS NULL OR AA2.[NotedAgentDefinitionId] IS NULL)
	AND (AA1.[NotedResourceDefinitionId] = AA2.[NotedResourceDefinitionId] OR AA1.[NotedResourceDefinitionId] IS NULL OR AA2.[NotedResourceDefinitionId] IS NULL)
	AND (AA1.[AgentId] = AA2.[AgentId] OR AA1.[AgentId] IS NULL OR AA2.[AgentId] IS NULL)
	AND (AA1.[ResourceId] = AA2.[ResourceId] OR AA1.[ResourceId] IS NULL OR AA2.[ResourceId] IS NULL)
	AND (AA1.[NotedAgentId] = AA2.[NotedAgentId] OR AA1.[NotedAgentId] IS NULL OR AA2.[NotedAgentId] IS NULL)
	AND (AA1.[NotedResourceId] = AA2.[NotedResourceId] OR AA1.[NotedResourceId] IS NULL OR AA2.[NotedResourceId] IS NULL)
	AND (AA1.[CenterId] = AA2.[CenterId] OR AA1.[CenterId] IS NULL OR AA2.[CenterId] IS NULL)
)
GO