...
(
	...
	PRIMARY KEY ([EmployeeId], [PostingDate])
)
AS
BEGIN
	DECLARE
	...
	INSERT INTO @EmployeeProfiles([EmployeeId], [PostingDate], [CenterId], [AgentId], [NotedResourceId], [EntryTypeId], [CurrencyId], [BasicSalary])
	SELECT E.[NotedAgentId], L.[PostingDate], E.[CenterId], E.[AgentId], E.[NotedResourceId], E.[EntryTypeId], E.[CurrencyId],
	...
	GROUP BY E.[NotedAgentId], L.[PostingDate], E.[CenterId], E.[AgentId], E.[NotedResourceId], E.[EntryTypeId], E.[CurrencyId]
