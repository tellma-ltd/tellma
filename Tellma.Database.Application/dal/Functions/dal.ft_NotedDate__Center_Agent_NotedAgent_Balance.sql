CREATE FUNCTION [dal].[ft_NotedDate__Center_Agent_NotedAgent_Balance] (
...
BEGIN
	...
	INSERT @returntable
	SELECT E.[NotedDate], E.[CenterId], E.[AgentId], E.[NotedAgentId], E.[ResourceId], E.[CurrencyId], SUM([Direction] * [MonetaryValue]) AS Balance
	FROM dbo.Entries E
	...
	GROUP BY E.[CenterId], E.[AgentId], E.[NotedAgentId], E.[ResourceId], E.[CurrencyId], E.[NotedDate]
	RETURN
END