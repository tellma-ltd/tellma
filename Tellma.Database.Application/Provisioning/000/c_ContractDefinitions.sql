...
(8, N'petty-cash-funds', N'Petty Cash Fund', N'Petty Cash Funds', N'money-check-alt', N'Cash',100),
(9, N'cashiers', N'Cashier', N'Cashiers', N'money-check-alt', N'Cash',101),
(10, N'warehouses', N'Warehouse', N'Warehouses', N'warehouse', N'Financials',60),
(11, N'foreign-imports', N'Foreign Import', N'Foreign Imports', N'file-import', N'Purchasing',120),
(12, N'foreign-exports', N'Foreign Export', N'Foreign Exports', N'file-export', N'Sales',120);
