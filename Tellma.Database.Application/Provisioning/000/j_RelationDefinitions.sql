INSERT INTO @RelationDefinitions([Index], [Code], [TitleSingular], [TitlePlural], [MainMenuIcon], [MainMenuSection], [MainMenuSortKey], [CenterVisibility], [ImageVisibility], [LocationVisibility], [FromDateVisibility], [FromDateLabel], [ToDateVisibility], [ToDateLabel], [TaxIdentificationNumberVisibility],[BankAccountNumberVisibility], [Relation1Visibility], [UserCardinality]) VALUES
(0, N'Creditor', N'Creditor', N'Creditors', N'hands', N'Financials',100,N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None', N'Single'),
(1, N'Debtor', N'Debtor', N'Debtors', N'hand-holding-usd', N'Financials',105,N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None', N'None'),
(2, N'Owner', N'Owner', N'Owners', N'power-off', N'Financials',110,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'Optional', N'Optional', N'None', N'Single'),
(3, N'Partner', N'Partner', N'Partners', N'user-tie', N'Financials',115,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'Optional', N'Optional', N'None', N'Single'),
(4, N'Supplier', N'Supplier', N'Suppliers', N'user-tag', N'Purchasing',120,N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'Optional', N'None', N'Single'),
(5, N'Customer', N'Customer', N'Customers ', N'user-shield', N'Sales',125,N'None', N'None', N'None', N'Optional', N'Customer Since', N'None', N'None', N'Optional', N'None', N'None', N'Single'),
(6, N'Employee', N'Employee', N'Employees', N'user-friends', N'HumanCapital',130,N'None', N'Optional', N'None', N'Optional', N'Joining Date', N'Optional', N'Termination Date', N'Optional', N'Optional', N'None', N'Single'),
(7, N'FamilyMember', N'Family Member', N'Family Members', N'user-circle', N'HumanCapital',135,N'None', N'Optional', N'None', N'Optional', N'DOB', N'None', N'None', N'None', N'None', N'Required', N'None'),
(8, N'Bank', N'Bank', N'Banks', N'landmark', N'Cash',140,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'None'),
(9, N'BankBranch', N'Bank Branch', N'Bank Branches', N'university', N'Cash',145,N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(10, N'Other', N'Other', N'Others', N'air-freshener', N'Financials',150,N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'None'),
(11, N'BankAccount', N'Bank Account', N'Bank Accounts', N'book', N'Cash',155,N'Required', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'Optional', N'None'),
(12, N'CashOnHandAccount', N'Cash Account', N'Cash On Hand Accounts', N'door-closed', N'Cash',160,N'Required', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Required', N'None'),
(13, N'Warehouse', N'Warehouse', N'Warehouses', N'warehouse', N'Inventory',165,N'Optional', N'Optional', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
...
(21, N'Buildings', N'Buildings', N'Buildings', N'building', N'FixedAssets',205,N'None', N'Optional', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(22, N'Machinery', N'Machinery', N'Machinery', N'cogs', N'FixedAssets',210,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(23, N'Ships', N'Ship', N'Ships', N'ship', N'FixedAssets',215,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(24, N'Aircraft', N'Aircraft', N'Aircrafts', N'plane', N'FixedAssets',220,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(25, N'MotorVehicles', N'Motor Vehicle', N'Motor Vehicles', N'car', N'FixedAssets',225,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(26, N'FixturesAndFittings', N'Fixture and fitting', N'Fixtures and fittings', N'puzzle-piece', N'FixedAssets',230,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(27, N'OfficeEquipment', N'Office equipment', N'Office equipment', N'fax', N'FixedAssets',235,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(28, N'BearerPlants', N'Bearer plant', N'Bearer plants', N'holly-berry', N'FixedAssets',240,N'None', N'Optional', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(29, N'TangibleExplorationAndEvaluationAssets', N'Tangible exploration and evaluation assets', N'Tangible exploration and evaluation assets', N'download', N'FixedAssets',245,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(30, N'MiningAssets', N'Mining asset', N'Mining assets', N'hammer', N'FixedAssets',250,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(31, N'OilAndGasAssets', N'Oil and gas asset', N'Oil and gas assets', N'gas-pump', N'FixedAssets',255,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(32, N'OwneroccupiedPropertyMeasuredUsingInvestmentPropertyFairValueModel', N'Owner-occupied property measured using investment property fair value model', N'Owner-occupied property measured using investment property fair value model', N'campground', N'FixedAssets',260,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(33, N'OtherPropertyPlantAndEquipment', N'Other property, plant and equipment', N'Other property, plant and equipment', N'tags', N'FixedAssets',265,N'None', N'Optional', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
(34, N'BrandNames', N'Brand name', N'Brand names', N'copyright', N'FixedAssets',270,N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'None', N'Optional', N'None'),
