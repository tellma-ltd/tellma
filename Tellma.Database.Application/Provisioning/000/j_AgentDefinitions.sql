...
DECLARE @GSMLicencesMemberAD INT = (SELECT [Id] FROM dbo.[AgentDefinitions] WHERE [Code] = N'GSMLicencesMember');
DECLARE @UMTSLicencesMemberAD INT = (SELECT [Id] FROM dbo.[AgentDefinitions] WHERE [Code] = N'UMTSLicencesMember');
