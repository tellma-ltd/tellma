...
(23, N'InventoryAdjustment',2, N'Shortage, Overage, impairment, reversal of impairment',N'Inventory Adjustment', N'Inventory Adjustments', N'MAV',NULL, N'Inventory', 1150),
...
(32, N'WithholdingTaxFromTradePayable',2, N'Witholding tax from suppliers/lessors',N'WT (Supplier)', N'WT (Suppliers)', N'WTS',NULL, N'Purchasing', 1190),
(33, N'ImportFromTradePayable',2, N'Shipment In Transit, Payment, Commercial Invoice, Related Expenses',N'Import Shipment', N'Import Shipments', N'IRS',NULL, N'Purchasing', 1200),
...
(42, N'WithholdingTaxByTradeReceivable',2, N'Witholding tax by customers/lessees',N'WT (Customer)', N'WT (Customers)', N'WTC',NULL, N'Sales', 1260),
...
(44, N'ExportToTradeReceivable',2, N'goods delivery from export',N'Goods Delivery (Export)', N'Goods Deliveries (Exports)', N'EIC',NULL, N'Sales', 1280),
...
(70, N'PaymentIssueToEmployee',2, N'payment - employee benefits, payment - employee loan, salary, overtime, absence, deduction, due installments, Bonus',N'Cash Payment', N'Cash Payments', N'PIE',NULL, N'HumanCapital', 1400),
(71, N'EmployeeLoan',2, N'salary advance, long term loan, loan installments',N'Employee Loan Voucher', N'', N'ELN',NULL, N'HumanCapital', 1410),
(72, N'AttendanceRegister',2, N'arrivals, departures',N'Attendance Register', N'Attendance Register', N'SRE',NULL, N'HumanCapital', 1420),
(73, N'EmployeeOvertime',2, N'Overtime (Employee)',N'Overtime', N'Overtime', N'ORE',NULL, N'HumanCapital', 1430),
(74, N'EmployeePenalty',2, N'absence penalty, Other penalties',N'Penalty', N'Penalties', N'PTE',NULL, N'HumanCapital', 1440),
(75, N'EmployeeReward',2, N'periodic bonus, special bonus',N'Reward', N'Rewards', N'RTE',NULL, N'HumanCapital', 1450),
(76, N'EmployeeLeave',2, N'Paid leave, Unpaid leave, hourly leave',N'Leave', N'Leaves', N'LIE',NULL, N'HumanCapital', 1460),
(77, N'EmployeeLeaveAllowance',2, N'Yearly Leave',N'Leave Allowance', N'Leave Allowances', N'LAE',NULL, N'HumanCapital', 1470),
(78, N'EmployeeTravel',2, N'Per diem, Petty Cash, Fuel Allowance, ...',N'Travel', N'Travels', N'TIE',NULL, N'HumanCapital', 1480);
