...
(17, N'OrdinarySharesMember', N'OtherFinancialLiabilities', N'Ordinary share', N'Ordinary shares', N'share-alt', N'Financials', 75,  N'Required', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'Single',NULL, N'None',NULL),
(18, N'PreferenceSharesMember', N'OtherFinancialLiabilities', N'Preference share', N'Preference shares', N'share-alt-square', N'Financials', 85,  N'Required', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'Single',NULL, N'None',NULL),
...
(21, N'InformationTechnologyMaintenanceAndSupportServices', N'Miscellaneous', N'IT Maintenance And Support Service', N'IT Maintenance And Support Services', N'qrcode', N'Sales', 115,  N'Required', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'Single',NULL, N'None',NULL),
(22, N'InformationTechnologyConsultingServices', N'Miscellaneous', N'IT Consulting Service', N'IT Consulting Services', N'question-circle', N'Sales', 125,  N'Required', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'Single',NULL, N'None',NULL),
(23, N'RoomOccupancyServices', N'Miscellaneous', N'Room Occupancy Service', N'Room Occupancy Services', N'person-booth', N'Sales', 135,  N'Required', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'Single',NULL, N'None',NULL),
...
(29, N'EmployeeBenefits', N'Miscellaneous', N'Employee Benefit', N'Employees Benefits', N'user-clock', N'HumanCapital', 35,  N'Required', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'Single',NULL, N'None',NULL),
(30, N'EmployeeDeductions', N'Miscellaneous', N'Employee Deduction', N'Employee Deductions', N'user-minus', N'HumanCapital', 50,  N'Required', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'Single',NULL, N'None',NULL),
(31, N'ChecksReceived', N'OtherFinancialAssets', N'Check Received', N'Checks Received', N'money-check', N'Financials', 65,  N'None', N'None', N'Optional', N'Optional', N'None', N'Optional', N'Check Date', N'Optional', N'Expiry Date', N'None', N'', N'None', N'', N'None',NULL, N'Required',@CustomerAD),
(32, N'FinancialGuarantees', N'OtherFinancialAssets', N'Financial Guarantee', N'Financial Guarantees', N'money-check', N'Financials', 65,  N'None', N'None', N'Optional', N'Optional', N'None', N'Optional', N'Check Date', N'Optional', N'Expiry Date', N'None', N'', N'None', N'', N'None',NULL, N'Required',@CustomerAD),
(33, N'LeaveTypes', N'Miscellaneous', N'Leave Type', N'Leave Types', N'sign-out-alt', N'HumanCapital', 55,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'Single',@d, N'None',NULL),
(34, N'Jobs', N'Miscellaneous', N'Job', N'Jobs', N'user-tag', N'HumanCapital', 56,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'None',NULL, N'None',NULL),
(35, N'Positions', N'Miscellaneous', N'Position', N'Positions', N'user-tie', N'HumanCapital', 57,  N'None', N'Required', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'Required', N'', N'None', N'', N'None',NULL, N'None',NULL),
(36, N'MarketingActivities', N'Miscellaneous', N'Marketing Activity', N'Marketing Activities', N'mail-bulk', N'Marketing', 90,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'None',NULL, N'None',NULL),
(37, N'DepreciationBases', N'PropertyPlantAndEquipment', N'Dep. Base', N'Dep. Bases', N'percentage', N'FixedAssets', 210,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'Single',NULL, N'None',NULL),
(38, N'AmortizationBases', N'IntangibleAssetsOtherThanGoodwill', N'Amo. Base', N'Amo. Bases', N'percent', N'FixedAssets', 220,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'Single',NULL, N'None',NULL),
(39, N'Attendances', N'Miscellaneous', N'Attendance', N'Attendances', N'user-clock', N'HumanCapital', 70,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'None',NULL, N'None',NULL),
(40, N'Tasks', N'Miscellaneous', N'Task', N'Tasks', N'tasks', N'Administration', 75,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'Required', N'Due Date', N'None', N'', N'None', N'', N'None',NULL, N'None',@EmployeeAD),
(41, N'AcademicDegrees', N'Miscellaneous', N'Academic Degree', N'Academic Degrees', N'user-graduate', N'HumanCapital', 85,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'None',NULL, N'None',NULL),
(42, N'ProfessionalCertifications', N'Miscellaneous', N'Professional Certification', N'Professional Certifications', N'certificate', N'HumanCapital', 110,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'None',NULL, N'None',NULL),
(43, N'Languages', N'Miscellaneous', N'Language', N'Languages', N'language', N'HumanCapital', 90,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'None',NULL, N'None',NULL),
(44, N'FamilyRelationships', N'Miscellaneous', N'Family Relationship', N'Family Relationships', N'user-friends', N'HumanCapital', 100,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'None',NULL, N'None',NULL),
(45, N'LicensesPermitsIds', N'Miscellaneous', N'License, Permit, Id', N'Licenses, Permits, Ids', N'id-badge', N'HumanCapital', 110,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'None',NULL, N'None',NULL),
(46, N'TransportationMeans', N'Miscellaneous', N'Transpotation Mean', N'Transpotation Means', N'bus', N'HumanCapital', 120,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'None',NULL, N'None',NULL),
(47, N'HousingMeans', N'Miscellaneous', N'Housing Mean', N'Housing Means', N'home', N'HumanCapital', 130,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'None',NULL, N'None',NULL),
(48, N'Breaches', N'Miscellaneous', N'Breach', N'Breaches', N'gavel', N'HumanCapital', 130,  N'None', N'None', N'None', N'Optional', N'None', N'None', N'', N'None', N'', N'None', N'', N'None', N'', N'None',NULL, N'None',NULL);
...
DECLARE @PositionsRD INT = (SELECT [Id] FROM dbo.[ResourceDefinitions] WHERE [Code] = N'Positions');
