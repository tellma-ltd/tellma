...
(N'ResourceDefinitions',N'Raw materials (Oil Milling)', N'ar', N'المواد الخام (طحن النفط)', N's'),(N'ResourceDefinitions',N'Raw materials (Oil Milling)', N'am', N'ጥሬ እቃዎች (ዘይት ቁፋሮ)', N's'),(N'ResourceDefinitions',N'Raw materials (Oil Milling)', N'cn', N'原料（制油）', N's'),(N'ResourceDefinitions',N'Raw materials (Oil Milling)', N'ar', N'مواد خام (عصر زيوت)', N'p'),(N'ResourceDefinitions',N'Raw materials (Oil Milling)', N'am', N'ጥሬ እቃዎች (ዘይት ቁፋሮ)', N'p'),(N'ResourceDefinitions',N'Raw materials (Oil Milling)', N'cn', N'原料（制油）', N'p'),
