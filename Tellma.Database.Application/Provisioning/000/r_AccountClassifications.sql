...
(110501,1105, N'110501',N'Investments in associates accounted for using equity method', N'الاستثمارات التي يتم محاسبتها باستخدام طريقة حقوق الملكية',@InvestmentsInAssociatesAccountedForUsingEquityMethod),
(110502,1105, N'110502',N'Investments in joint ventures accounted for using equity method', N'الاستثمارات في الشركات التابعة والمشاريع المشتركة والشركات الزميلة',@InvestmentsInJointVenturesAccountedForUsingEquityMethod),
...
(320102,3201, N'320102',N'Other current provisions', N'الأحكام الحالية أخرى',@OtherShorttermProvisions),
...
(4101,41, N'4101',N'Revenue from sale of goods', N'الإيرادات من بيع السلع',@RevenueFromSaleOfGoods),
...
(4102,41, N'4102',N'Revenue from rendering of services', N'الإيرادات من تقديم الخدمات',@RevenueFromRenderingOfServices),
...
(4103,41, N'4103',N'Revenue from construction contracts', N'الإيرادات من عقود البناء',@RevenueFromConstructionContracts),
(4104,41, N'4104',N'Royalty income', N'دخل الملكية',@RevenueFromRoyalties),
(4105,41, N'4105',N'Licence fee income', N'دخل رسوم الترخيص',@LicenceFeeIncome),
(4106,41, N'4106',N'Franchise fee income', N'دخل رسوم الامتياز',@FranchiseFeeIncome),
(4107,41, N'4107',N'Interest income', N'إيرادات الفوائد',@RevenueFromInterest),
(4108,41, N'4108',N'Dividend income', N'توزيعات الارباح',@RevenueFromDividends),
(4199,41, N'4199',N'Other revenue', N'ايرادات اخرى',@OtherRevenue),
...
(4303,43, N'4303',N'Services expense', N'حساب الخدمات',@ServicesExpense),
(430301,4303, N'430301',N'Insurance expense', N'مصاريف التأمين',@InsuranceExpense),
(430302,4303, N'430302',N'Professional fees expense', N'حساب الأتعاب المهنية',@ProfessionalFeesExpense),
(430303,4303, N'430303',N'Transportation expense', N'حساب وسائل النقل',@TransportationExpense),
(430304,4303, N'430304',N'Bank and similar charges', N'الرسوم البنكية ومثيلاتها',@BankAndSimilarCharges),
...
(430402,4304, N'430402',N'Social security contributions', N'اشتراكات الضمان الاجتماعي',@SocialSecurityContributions),
(430403,4304, N'430403',N'Other short-term employee benefits', N'منافع الموظفين قصيرة الأجل الأخرى',@OtherShorttermEmployeeBenefits),
(430404,4304, N'430404',N'Post-employment benefit expense, defined contribution plans', N'حساب استحقاقات ما بعد التوظيف، تخطيط تشاركي',@PostemploymentBenefitExpenseDefinedContributionPlans),
(430405,4304, N'430405',N'Post-employment benefit expense, defined benefit plans', N'حساب استحقاقات ما بعد التوظيف وخطط المنافع المحددة',@PostemploymentBenefitExpenseDefinedBenefitPlans),
(430406,4304, N'430406',N'Termination benefits expense', N'حساب مكافأة نهاية الخدمة',@TerminationBenefitsExpense),
(430407,4304, N'430407',N'Other long-term employee benefits', N'استحقاقات الموظفين طويلة الأجل الأخرى',@OtherLongtermBenefits),
(430499,4304, N'430499',N'Other employee expense', N'مصروفات موظفين - أخرى',@OtherEmployeeExpense),
(4305,43, N'4305',N'Depreciation and amortisation expense', N'مصاريف الاستهلاك والإطفاء',@DepreciationAndAmortisationExpense),
(430501,4305, N'430501',N'Depreciation expense', N'مصاريف الاستهلاك',@DepreciationExpense),
(430502,4305, N'430502',N'Amortisation expense', N'حساب الاستهلاك',@AmortisationExpense),
...
(430601,4306, N'430601',N'Write-downs (reversals of write-downs) of inventories', N'شطب (انتكاسات من شطب) من المخزون',@WritedownsReversalsOfInventories),
(430602,4306, N'430602',N'Write-downs (reversals of write-downs) of property, plant and equipment', N'شطب (انتكاسات من شطب) الممتلكات والآلات والمعدات',@WritedownsReversalsOfPropertyPlantAndEquipment),
...
(4401,44, N'4401',N'Gain (loss) on disposal of property, plant and equipment', N'الربح (الخسارة) من بيع ممتلكات وآلات ومعدات',@GainLossOnDisposalOfPropertyPlantAndEquipmentExtension),
