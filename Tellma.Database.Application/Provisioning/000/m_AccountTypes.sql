...
INSERT INTO @AT VALUES(2111016,0,0,'2111016', '/2/1/1/1/1/6/', N'ChangesInExpenseByNatureExtension',N'ReallocatedExpensesExtension', N'Reallocated expenses',N'')
...
INSERT INTO @AT VALUES(51,0,1,'51', '/5/1/', NULL,N'FinancialsExtension', N'Financials',N'')
INSERT INTO @AT VALUES(52,0,0,'52', '/5/2/', NULL,N'FixedAssetsExtenstion', N'Fixed Assets',N'')
INSERT INTO @AT VALUES(53,0,0,'53', '/5/3/', NULL,N'InventoriesExtension', N'Inventory',N'')
INSERT INTO @AT VALUES(54,0,0,'54', '/5/4/', NULL,N'OperationsExtension', N'Operation',N'')
INSERT INTO @AT VALUES(55,0,0,'55', '/5/5/', NULL,N'PurchasingExtension', N'Purchasing',N'')
INSERT INTO @AT VALUES(56,0,0,'56', '/5/6/', NULL,N'CRMExtension', N'CRM',N'')
INSERT INTO @AT VALUES(57,0,0,'57', '/5/7/', NULL,N'SalesExtension', N'Sales',N'')
INSERT INTO @AT VALUES(58,0,0,'58', '/5/8/', NULL,N'HRExtension', N'HR',N'')
INSERT INTO @AT VALUES(59,0,0,'59', '/5/9/', NULL,N'PayrollExtension', N'Payroll',N'')
...
DECLARE @FinancialsExtension INT = (SELECT [Id] FROM dbo.AccountTypes WHERE [Concept] = N'FinancialsExtension');
DECLARE @FixedAssetsExtenstion INT = (SELECT [Id] FROM dbo.AccountTypes WHERE [Concept] = N'FixedAssetsExtenstion');
DECLARE @InventoriesExtension INT = (SELECT [Id] FROM dbo.AccountTypes WHERE [Concept] = N'InventoriesExtension');
DECLARE @OperationsExtension INT = (SELECT [Id] FROM dbo.AccountTypes WHERE [Concept] = N'OperationsExtension');
DECLARE @PurchasingExtension INT = (SELECT [Id] FROM dbo.AccountTypes WHERE [Concept] = N'PurchasingExtension');
DECLARE @CRMExtension INT = (SELECT [Id] FROM dbo.AccountTypes WHERE [Concept] = N'CRMExtension');
DECLARE @SalesExtension INT = (SELECT [Id] FROM dbo.AccountTypes WHERE [Concept] = N'SalesExtension');
...
(65,@ConstructionInProgress,@ConstructionInProgressMemberAD),
(70,@OwneroccupiedPropertyMeasuredUsingInvestmentPropertyFairValueModel,@OwneroccupiedPropertyMeasuredUsingInvestmentPropertyFairValueModelMemberAD),
(75,@OtherPropertyPlantAndEquipment,@OtherPropertyPlantAndEquipmentMemberAD),
(80,@InvestmentPropertyCompleted,@InvestmentPropertyCompletedMemberAD),
(85,@InvestmentPropertyUnderConstructionOrDevelopment,@InvestmentPropertyUnderConstructionOrDevelopmentMemberAD),
(90,@Goodwill,@SubsidiaryAD),
(95,@BrandNames,@BrandNamesMemberAD),
(100,@IntangibleExplorationAndEvaluationAssets,@IntangibleExplorationAndEvaluationAssetsMemberAD),
(105,@MastheadsAndPublishingTitles,@MastheadsAndPublishingTitlesMemberAD),
(110,@ComputerSoftware,@ComputerSoftwareMemberAD),
(115,@LicencesAndFranchises,@LicencesMemberAD),
(120,@CopyrightsPatentsAndOtherIndustrialPropertyRightsServiceAndOperatingRights,@CopyrightsPatentsAndOtherIndustrialPropertyRightsServiceAndOperatingRightsMemberAD),
(125,@RecipesFormulaeModelsDesignsAndPrototypes,@RecipesFormulaeModelsDesignsAndPrototypesMemberAD),
(130,@IntangibleAssetsUnderDevelopment,@IntangibleAssetsUnderDevelopmentMemberAD),
(135,@OtherIntangibleAssets,@OtherIntangibleAssetsMemberAD),
(140,@InvestmentsInAssociatesAccountedForUsingEquityMethod,@AssociateAD),
(145,@InvestmentsInJointVenturesAccountedForUsingEquityMethod,@JointVentureAD),
(150,@InvestmentsInSubsidiaries,@SubsidiaryAD),
(155,@InvestmentsInJointVentures,@JointVentureAD),
(160,@InvestmentsInAssociates,@AssociateAD),
(165,@NoncurrentBiologicalAssets,@FarmAD),
(170,@NoncurrentTradeReceivables,@SalesInvoiceAD),
(175,@NoncurrentReceivablesDueFromRelatedParties,@SalesInvoiceAD),
(180,@NoncurrentPrepayments,@SupplierAD),
(185,@NoncurrentAccruedIncome,@CustomerAD),
(190,@NoncurrentReceivablesFromTaxesOtherThanIncomeTax,@TaxDepartmentAD),
(195,@NoncurrentValueAddedTaxReceivables,@TaxDepartmentAD),
(200,@NoncurrentReceivablesFromSaleOfProperties,@SalesInvoiceAD),
(205,@NoncurrentReceivablesFromRentalOfProperties,@SalesInvoiceAD),
(210,@DeferredTaxAssets,@TaxDepartmentAD),
(215,@CurrentTaxAssetsNoncurrent,@TaxDepartmentAD),
(220,@NoncurrentLoansAndReceivables,@EmployeeLoanAD),
(225,@Merchandise,@WarehouseAD),
(230,@CurrentFoodAndBeverage,@WarehouseAD),
(235,@CurrentAgriculturalProduce,@WarehouseAD),
(240,@FinishedGoods,@WarehouseAD),
(245,@WorkInProgress,@ProductionOrderAD),
(250,@RawMaterials,@WarehouseAD),
(255,@ProductionSupplies,@WarehouseAD),
(260,@CurrentPackagingAndStorageMaterials,@WarehouseAD),
(265,@SpareParts,@WarehouseAD),
(270,@CurrentFuel,@WarehouseAD),
(275,@CurrentInventoriesInTransit,@IncomingShipmentAD),
(280,@OtherInventories,@WarehouseAD),
(285,@CurrentTradeReceivables,@SalesInvoiceAD),
(290,@TradeAndOtherCurrentReceivablesDueFromRelatedParties,@SalesInvoiceAD),
(295,@CurrentAdvancesToSuppliers,@SupplierAD),
(300,@CurrentPrepaidExpenses,@SupplierAD),
(305,@CurrentAccruedIncome,@CustomerAD),
(310,@CurrentReceivablesFromTaxesOtherThanIncomeTax,@TaxDepartmentAD),
(315,@CurrentValueAddedTaxReceivables,@TaxDepartmentAD),
(320,@CurrentReceivablesFromRentalOfProperties,@SalesInvoiceAD),
(325,@CurrentTaxAssetsCurrent,@TaxDepartmentAD),
(330,@CurrentBiologicalAssets,@FarmAD),
(335,@CurrentLoansAndReceivables,@EmployeeLoanAD),
(340,@CurrentFinancialAssetsAtAmortisedCost,@DebtorAD),
(345,@CashOnHand,@CashOnHandAccountAD),
(350,@BalancesWithBanks,@BankAccountAD),
(360,@OtherCashAndCashEquivalents,@CashOnHandAccountAD),
(365,@NoncurrentAssetsOrDisposalGroupsClassifiedAsHeldForSale,@MotorVehiclesMemberAD),
(370,@NoncurrentAssetsOrDisposalGroupsClassifiedAsHeldForDistributionToOwners,@OfficeEquipmentMemberAD),
(375,@IssuedCapital,@PartnerAD),
(380,@NoncurrentProvisionsForEmployeeBenefits,@EmployeeAD),
(385,@NoncurrentPayablesToTradeSuppliers,@PurchaseInvoiceAD),
(390,@NoncurrentPayablesToRelatedParties,@PurchaseInvoiceAD),
(395,@DeferredIncomeClassifiedAsNoncurrent,@SalesInvoiceAD),
(400,@RentDeferredIncomeClassifiedAsNoncurrent,@SalesInvoiceAD),
(405,@AccrualsClassifiedAsNoncurrent,@SupplierAD),
(410,@NoncurrentValueAddedTaxPayables,@TaxDepartmentAD),
(415,@NoncurrentExciseTaxPayables,@TaxDepartmentAD),
(420,@NoncurrentRetentionPayables,@PurchaseInvoiceAD),
(425,@NoncurrentFinancialLiabilitiesAtAmortisedCost,@BankBorrowingAccountAD),
(430,@CurrentProvisionsForEmployeeBenefits,@EmployeeAD),
(435,@TradeAndOtherCurrentPayablesToTradeSuppliers,@PurchaseInvoiceAD),
(440,@TradeAndOtherCurrentPayablesToRelatedParties,@PurchaseInvoiceAD),
(445,@DeferredIncomeClassifiedAsCurrent,@SalesInvoiceAD),
(450,@RentDeferredIncomeClassifiedAsCurrent,@SalesInvoiceAD),
(455,@AccrualsClassifiedAsCurrent,@SupplierAD),
...
(495,@CurrentFinancialLiabilitiesAtAmortisedCost,@BankBorrowingAccountAD),
(500,@RevenueFromSaleOfGoods,@CustomerAD ),
(505,@RevenueFromSaleOfCopper,@CustomerAD ),
(510,@RevenueFromSaleOfGold,@CustomerAD ),
(515,@RevenueFromSaleOfSilver,@CustomerAD ),
(520,@RevenueFromSaleOfOilAndGasProducts,@CustomerAD ),
(525,@RevenueFromSaleOfCrudeOil,@CustomerAD ),
(530,@RevenueFromSaleOfAgriculturalProduce,@CustomerAD ),
(535,@RevenueFromSaleOfFoodAndBeverage,@CustomerAD ),
(540,@RevenueFromRenderingOfServices,@CustomerAD ),
(545,@RevenueFromRenderingOfTelecommunicationServices,@CustomerAD ),
(550,@RevenueFromRenderingOfTransportServices,@CustomerAD ),
(555,@RevenueFromRenderingOfInformationTechnologyServices,@CustomerAD ),
(560,@RevenueFromRenderingOfInformationTechnologyMaintenanceAndSupportServices,@CustomerAD ),
...
(600,@CostOfMerchandiseSold,@CustomerAD),
(605,@InsuranceExpense,@MotorVehiclesMemberAD),
(610,@RepairsAndMaintenanceExpense,@MotorVehiclesMemberAD),
(615,@TransportationExpense,@IncomingShipmentAD),
(620,@BankAndSimilarCharges,@IncomingShipmentAD),
(625,@EmployeeBenefitsExpense,@CustomerAD),
(630,@ShorttermEmployeeBenefitsExpense,@CustomerAD),
(635,@WagesAndSalaries,@CustomerAD),
(640,@SocialSecurityContributions,@CustomerAD),
(645,@OtherShorttermEmployeeBenefits,@CustomerAD),
(650,@PostemploymentBenefitExpenseDefinedContributionPlans,@CustomerAD),
(655,@PostemploymentBenefitExpenseDefinedBenefitPlans,@CustomerAD),
(660,@TerminationBenefitsExpense,@CustomerAD),
(665,@OtherLongtermBenefits,@CustomerAD),
(670,@OtherEmployeeExpense,@CustomerAD),
(675,@DepreciationExpense,@MachineryMemberAD),
(680,@AmortisationExpense,@LicencesMemberAD),
(685,@FinancialsExtension,@CashOnHandAccountAD),
(690,@FixedAssetsExtenstion,@EmployeeAD),
(695,@OperationsExtension,@ProductionOrderAD),
(700,@CRMExtension,@ProspectAD),
(705,@HRExtension,@EmployeeAD),
(710,@PayrollExtension,@EmployeeAD),

(10036,@FixturesAndFittings,@NetworkInfrastructureMemberAD),
(10037,@FixturesAndFittings,@LeaseholdImprovementsMemberAD),
(10041,@OfficeEquipment,@ComputerEquipmentMemberAD),
(10042,@OfficeEquipment,@CommunicationAndNetworkEquipmentMemberAD),
--(10100,@LicencesAndFranchises,@GSMLicencesMemberAD),
--(10101,@LicencesAndFranchises,@UMTSLicencesMemberAD),
--(10102,@LicencesAndFranchises,@LTELicencesMemberAD),
--(10103,@LicencesAndFranchises,@GamingLicencesMemberAD),
(10104,@LicencesAndFranchises,@FranchisesMemberAD),
(10105,@CopyrightsPatentsAndOtherIndustrialPropertyRightsServiceAndOperatingRights,@AirportLandingRightsMemberAD),
(10106,@CopyrightsPatentsAndOtherIndustrialPropertyRightsServiceAndOperatingRights,@MiningRightsMemberAD),
(10107,@CopyrightsPatentsAndOtherIndustrialPropertyRightsServiceAndOperatingRights,@BroadcastingRightsMemberAD),
(10108,@CopyrightsPatentsAndOtherIndustrialPropertyRightsServiceAndOperatingRights,@ServiceConcessionRightsMemberAD),
(10109,@NoncurrentLoansAndReceivables,@EmployeeAD),
(10166,@Merchandise,@AisleBinShelfAD),
(10171,@CurrentFoodAndBeverage,@AisleBinShelfAD),
(10176,@CurrentAgriculturalProduce,@AisleBinShelfAD),
(10181,@FinishedGoods,@AisleBinShelfAD),
(10186,@WorkInProgress,@AisleBinShelfAD),
(10191,@RawMaterials,@AisleBinShelfAD),
(10196,@ProductionSupplies,@AisleBinShelfAD),
(10201,@CurrentPackagingAndStorageMaterials,@AisleBinShelfAD),
(10206,@SpareParts,@AisleBinShelfAD),
(10211,@CurrentFuel,@AisleBinShelfAD),
(10221,@OtherInventories,@AisleBinShelfAD),
(10225,@CashOnHand,@EmployeeAD),
(10365,@NoncurrentAssetsOrDisposalGroupsClassifiedAsHeldForSale,@LandMemberAD),
(10366,@NoncurrentAssetsOrDisposalGroupsClassifiedAsHeldForSale,@BuildingsMemberAD),
(10367,@NoncurrentAssetsOrDisposalGroupsClassifiedAsHeldForSale,@MachineryMemberAD),
(10368,@NoncurrentAssetsOrDisposalGroupsClassifiedAsHeldForSale,@PowerGeneratingAssetsMemberAD),
(10369,@NoncurrentAssetsOrDisposalGroupsClassifiedAsHeldForSale,@AircraftMemberAD),
--(10370,@NoncurrentAssetsOrDisposalGroupsClassifiedAsHeldForSale,@MotorVehiclesMemberAD),
(10371,@NoncurrentAssetsOrDisposalGroupsClassifiedAsHeldForSale,@OfficeEquipmentMemberAD),
(10372,@NoncurrentAssetsOrDisposalGroupsClassifiedAsHeldForSale,@ComputerEquipmentMemberAD),

(10375,@NoncurrentAssetsOrDisposalGroupsClassifiedAsHeldForDistributionToOwners,@LandMemberAD),
(10376,@NoncurrentAssetsOrDisposalGroupsClassifiedAsHeldForDistributionToOwners,@BuildingsMemberAD),

(10401,@OtherIncome,@EmployeeAD),
(10402,@OtherIncome,@SupplierAD),

(10540,@RawMaterialsAndConsumablesUsed,@LandMemberAD),
(10541,@RawMaterialsAndConsumablesUsed,@BuildingsMemberAD),
(10542,@RawMaterialsAndConsumablesUsed,@MachineryMemberAD),
(10543,@RawMaterialsAndConsumablesUsed,@PowerGeneratingAssetsMemberAD),
(10544,@RawMaterialsAndConsumablesUsed,@ShipsMemberAD),
(10545,@RawMaterialsAndConsumablesUsed,@AircraftMemberAD),
(10546,@RawMaterialsAndConsumablesUsed,@MotorVehiclesMemberAD),
(10547,@RawMaterialsAndConsumablesUsed,@FixturesAndFittingsMemberAD),
(10548,@RawMaterialsAndConsumablesUsed,@NetworkInfrastructureMemberAD),
(10549,@RawMaterialsAndConsumablesUsed,@LeaseholdImprovementsMemberAD),
(10550,@RawMaterialsAndConsumablesUsed,@OfficeEquipmentMemberAD),
(10551,@RawMaterialsAndConsumablesUsed,@ComputerEquipmentMemberAD),
(10552,@RawMaterialsAndConsumablesUsed,@CommunicationAndNetworkEquipmentMemberAD),
(10553,@RawMaterialsAndConsumablesUsed,@BearerPlantsMemberAD),
(10554,@RawMaterialsAndConsumablesUsed,@TangibleExplorationAndEvaluationAssetsMemberAD),
(10555,@RawMaterialsAndConsumablesUsed,@MiningAssetsMemberAD),
(10556,@RawMaterialsAndConsumablesUsed,@OilAndGasAssetsMemberAD),
(10557,@RawMaterialsAndConsumablesUsed,@ConstructionInProgressMemberAD),
(10558,@RawMaterialsAndConsumablesUsed,@OwneroccupiedPropertyMeasuredUsingInvestmentPropertyFairValueModelMemberAD),
(10559,@RawMaterialsAndConsumablesUsed,@OtherPropertyPlantAndEquipmentMemberAD),
--
(10560,@RawMaterialsAndConsumablesUsed,@InvestmentPropertyUnderConstructionOrDevelopmentMemberAD),
(10561,@RawMaterialsAndConsumablesUsed,@ProductionOrderAD),
(10562,@RawMaterialsAndConsumablesUsed,@IncomingShipmentAD),
--
(10590,@FuelExpense,@BuildingsMemberAD),
(10591,@FuelExpense,@MachineryMemberAD),
(10592,@FuelExpense,@PowerGeneratingAssetsMemberAD),
(10593,@FuelExpense,@ShipsMemberAD),
(10594,@FuelExpense,@AircraftMemberAD),
--(10595,@FuelExpense,@MotorVehiclesMemberAD),
(10596,@FuelExpense,@OfficeEquipmentMemberAD),
(10597,@FuelExpense,@TangibleExplorationAndEvaluationAssetsMemberAD),
(10598,@FuelExpense,@MiningAssetsMemberAD),
(10599,@FuelExpense,@ConstructionInProgressMemberAD),
(10600,@FuelExpense,@OwneroccupiedPropertyMeasuredUsingInvestmentPropertyFairValueModelMemberAD),
--
(10611,@InsuranceExpense,@BuildingsMemberAD),
--(10616,@InsuranceExpense,@MotorVehiclesMemberAD),
(10630,@InsuranceExpense,@IncomingShipmentAD),

(10640,@ProfessionalFeesExpense,@LandMemberAD),
(10641,@ProfessionalFeesExpense,@BuildingsMemberAD),
(10642,@ProfessionalFeesExpense,@MachineryMemberAD),
(10643,@ProfessionalFeesExpense,@PowerGeneratingAssetsMemberAD),
(10644,@ProfessionalFeesExpense,@ShipsMemberAD),
(10645,@ProfessionalFeesExpense,@AircraftMemberAD),
(10646,@ProfessionalFeesExpense,@MotorVehiclesMemberAD),
(10647,@ProfessionalFeesExpense,@FixturesAndFittingsMemberAD),
(10648,@ProfessionalFeesExpense,@NetworkInfrastructureMemberAD),
(10649,@ProfessionalFeesExpense,@LeaseholdImprovementsMemberAD),
(10650,@ProfessionalFeesExpense,@OfficeEquipmentMemberAD),
(10651,@ProfessionalFeesExpense,@ComputerEquipmentMemberAD),
(10652,@ProfessionalFeesExpense,@CommunicationAndNetworkEquipmentMemberAD),
(10653,@ProfessionalFeesExpense,@BearerPlantsMemberAD),
(10654,@ProfessionalFeesExpense,@TangibleExplorationAndEvaluationAssetsMemberAD),
(10655,@ProfessionalFeesExpense,@MiningAssetsMemberAD),
(10656,@ProfessionalFeesExpense,@OilAndGasAssetsMemberAD),
(10657,@ProfessionalFeesExpense,@ConstructionInProgressMemberAD),
(10658,@ProfessionalFeesExpense,@OwneroccupiedPropertyMeasuredUsingInvestmentPropertyFairValueModelMemberAD),
(10659,@ProfessionalFeesExpense,@OtherPropertyPlantAndEquipmentMemberAD),
--
(10760,@ProfessionalFeesExpense,@InvestmentPropertyUnderConstructionOrDevelopmentMemberAD),
(10761,@ProfessionalFeesExpense,@ProductionOrderAD),
(10762,@ProfessionalFeesExpense,@IncomingShipmentAD),
(10763,@ProfessionalFeesExpense,@CustomerAD),
(10765,@ProfessionalFeesExpense,@EmployeeAD),

(10840,@RepairsAndMaintenanceExpense,@LandMemberAD),
(10841,@RepairsAndMaintenanceExpense,@BuildingsMemberAD),
(10842,@RepairsAndMaintenanceExpense,@MachineryMemberAD),
(10843,@RepairsAndMaintenanceExpense,@PowerGeneratingAssetsMemberAD),
(10844,@RepairsAndMaintenanceExpense,@ShipsMemberAD),
(10845,@RepairsAndMaintenanceExpense,@AircraftMemberAD),
--(10846,@RepairsAndMaintenanceExpense,@MotorVehiclesMemberAD),
(10847,@RepairsAndMaintenanceExpense,@FixturesAndFittingsMemberAD),
(10848,@RepairsAndMaintenanceExpense,@NetworkInfrastructureMemberAD),
(10849,@RepairsAndMaintenanceExpense,@LeaseholdImprovementsMemberAD),
(10850,@RepairsAndMaintenanceExpense,@OfficeEquipmentMemberAD),
(10851,@RepairsAndMaintenanceExpense,@ComputerEquipmentMemberAD),
(10852,@RepairsAndMaintenanceExpense,@CommunicationAndNetworkEquipmentMemberAD),
(10853,@RepairsAndMaintenanceExpense,@BearerPlantsMemberAD),
(10854,@RepairsAndMaintenanceExpense,@TangibleExplorationAndEvaluationAssetsMemberAD),
(10855,@RepairsAndMaintenanceExpense,@MiningAssetsMemberAD),
(10856,@RepairsAndMaintenanceExpense,@OilAndGasAssetsMemberAD),
(10857,@RepairsAndMaintenanceExpense,@ConstructionInProgressMemberAD),
(10858,@RepairsAndMaintenanceExpense,@OwneroccupiedPropertyMeasuredUsingInvestmentPropertyFairValueModelMemberAD),
(10859,@RepairsAndMaintenanceExpense,@OtherPropertyPlantAndEquipmentMemberAD),

(10860,@TransportationExpense,@InvestmentPropertyUnderConstructionOrDevelopmentMemberAD),
(10861,@TransportationExpense,@ProductionOrderAD),
--(10862,@TransportationExpense,@IncomingShipmentAD),
(10863,@TransportationExpense,@CustomerAD),

--(10962,@BankAndSimilarCharges,@IncomingShipmentAD),
(10963,@BankAndSimilarCharges,@CustomerAD),

(11060,@TravelExpense,@InvestmentPropertyUnderConstructionOrDevelopmentMemberAD),
(11061,@TravelExpense,@ProductionOrderAD),
(11062,@TravelExpense,@IncomingShipmentAD),
(11063,@TravelExpense,@CustomerAD),

(11160,@CommunicationExpense,@InvestmentPropertyUnderConstructionOrDevelopmentMemberAD),
(11161,@CommunicationExpense,@ProductionOrderAD),
(11162,@CommunicationExpense,@IncomingShipmentAD),
(11163,@CommunicationExpense,@CustomerAD),

(11260,@UtilitiesExpense,@InvestmentPropertyUnderConstructionOrDevelopmentMemberAD),
(11261,@UtilitiesExpense,@ProductionOrderAD),

(11360,@AdvertisingExpense,@InvestmentPropertyUnderConstructionOrDevelopmentMemberAD),
(11363,@AdvertisingExpense,@CustomerAD),

(11460,@RentalExpense,@InvestmentPropertyUnderConstructionOrDevelopmentMemberAD),
(11461,@RentalExpense,@ProductionOrderAD),
(11462,@RentalExpense,@IncomingShipmentAD),
(11463,@RentalExpense,@CustomerAD),


(11640,@DepreciationExpense,							@LandMemberAD),
(11657,@DepreciationExpense,							@BuildingsMemberAD),
--(11658,@DepreciationExpense,							@MachineryMemberAD), 
(11659,@DepreciationExpense,							@PowerGeneratingAssetsMemberAD),
(11660,@DepreciationExpense,							@ShipsMemberAD),
(11661,@DepreciationExpense,							@AircraftMemberAD),
(11662,@DepreciationExpense,							@MotorVehiclesMemberAD),
(11663,@DepreciationExpense,							@FixturesAndFittingsMemberAD),
(11664,@DepreciationExpense,							@NetworkInfrastructureMemberAD),
(11665,@DepreciationExpense,							@LeaseholdImprovementsMemberAD),
(11666,@DepreciationExpense,							@OfficeEquipmentMemberAD),
(11667,@DepreciationExpense,							@ComputerEquipmentMemberAD),
(11668,@DepreciationExpense,							@CommunicationAndNetworkEquipmentMemberAD),
(11669,@DepreciationExpense,							@BearerPlantsMemberAD),
(11670,@DepreciationExpense,							@TangibleExplorationAndEvaluationAssetsMemberAD),
(11671,@DepreciationExpense,							@MiningAssetsMemberAD),
(11672,@DepreciationExpense,							@OilAndGasAssetsMemberAD),
(11673,@DepreciationExpense,							@ConstructionInProgressMemberAD),
(11674,@DepreciationExpense,							@OwneroccupiedPropertyMeasuredUsingInvestmentPropertyFairValueModelMemberAD),
(11675,@DepreciationExpense,							@OtherPropertyPlantAndEquipmentMemberAD),

(11740,@AmortisationExpense,							@BrandNamesMemberAD),
(11757,@AmortisationExpense,							@IntangibleExplorationAndEvaluationAssetsMemberAD),
(11758,@AmortisationExpense,							@MastheadsAndPublishingTitlesMemberAD), 
(11759,@AmortisationExpense,							@ComputerSoftwareMemberAD),
--(11760,@AmortisationExpense,							@LicencesMemberAD),
(11765,@AmortisationExpense,							@FranchisesMemberAD),
(11766,@AmortisationExpense,							@CopyrightsPatentsAndOtherIndustrialPropertyRightsServiceAndOperatingRightsMemberAD),
(11767,@AmortisationExpense,							@AirportLandingRightsMemberAD),
(11768,@AmortisationExpense,							@MiningRightsMemberAD),
(11769,@AmortisationExpense,							@BroadcastingRightsMemberAD),
(11770,@AmortisationExpense,							@ServiceConcessionRightsMemberAD),
(11771,@AmortisationExpense,							@RecipesFormulaeModelsDesignsAndPrototypesMemberAD),
(11772,@AmortisationExpense,							@CustomerrelatedIntangibleAssetsMemberAD),
(11773,@AmortisationExpense,							@ValueOfBusinessAcquiredMemberAD),
(11774,@AmortisationExpense,							@CapitalisedDevelopmentExpenditureMemberAD),
(11775,@AmortisationExpense,							@TechnologybasedIntangibleAssetsMemberAD),
(11780,@AmortisationExpense,							@IntangibleAssetsUnderDevelopmentMemberAD),
(11785,@AmortisationExpense,							@OtherIntangibleAssetsMemberAD),
(11801,@DonationsAndSubsidiesExpense,					@PurchaseInvoiceAD),
(11802,@DonationsAndSubsidiesExpense,					@SalesInvoiceAD),
(11803,@DonationsAndSubsidiesExpense,					@EmployeeAD),
(11966,@FinancialsExtension,							@EmployeeAD),
(11991,@CRMExtension,									@CustomerAD);
...
(80,@Goodwill,											@AmortizationBasesRD),
(81,@BrandNames,										@AmortizationBasesRD),
...
(735,@WagesAndSalaries,									@EmployeeBenefitsRD),
(746,@WagesAndSalaries,									@EmployeeDeductionsRD), 

(740,@SocialSecurityContributions,						@EmployeeBenefitsRD),
...
(879,@WritedownsReversalsOfInventories,					@FinishedGoodsRD),
(880,@FinancialsExtension,								@ChecksReceivedRD), -- for checks received as guarantee
...
(897,@PayrollExtension,									@JobsRD), -- Jobs Allowances
...
(907,@HRExtension,										@PositionsRD), -- Secretary, accountant, manager
...
(1005,@NoncurrentValueAddedTaxReceivables,@SupplierAD),
(1010,@CurrentValueAddedTaxReceivables,@SupplierAD),
...
(1133,@InsuranceExpense,@SupplierAD),
(1135,@ProfessionalFeesExpense,@SupplierAD),
(1140,@RepairsAndMaintenanceExpense,@SupplierAD),
(1145,@TransportationExpense,@SupplierAD),
(1150,@BankAndSimilarCharges,@SupplierAD),
(1155,@TravelExpense,@SupplierAD),
(1160,@CommunicationExpense,@SupplierAD),
(1165,@UtilitiesExpense,@SupplierAD),
(1170,@AdvertisingExpense,@SupplierAD),
(1173,@RentalExpense,@SupplierAD),
(1180,@SocialSecurityContributions,@TaxDepartmentAD),
(1185,@OtherShorttermEmployeeBenefits,@SupplierAD),
(1201,@TerminationBenefitsExpense,@SupplierAD),
(1206,@OtherLongtermBenefits,@SupplierAD),
(1211,@OtherEmployeeExpense,@SupplierAD),
(1701,@FinancialsExtension, @EmployeeAD),
(1702,@FinancialsExtension, @CustomerAD),
