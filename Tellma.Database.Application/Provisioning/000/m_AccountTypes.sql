...
(353,@NoncurrentFinancialLiabilitiesAtAmortisedCost, @CreditorAD),
...
(453,@CurrentFinancialLiabilitiesAtAmortisedCost, @CreditorAD),
...
(1801,@DonationsAndSubsidiesExpense,@SupplierAD),
(1802,@DonationsAndSubsidiesExpense,@CustomerAD),
...
--(5,@Land,@SupplierAD),
--(10,@Buildings,@SupplierAD),
--(15,@Machinery,@SupplierAD),
--(20,@Ships,@SupplierAD),
--(25,@Aircraft,@SupplierAD),
--(30,@MotorVehicles,@SupplierAD),
--(35,@FixturesAndFittings,@SupplierAD),
--(40,@OfficeEquipment,@SupplierAD),
--(45,@BearerPlants,@SupplierAD),
--(50,@TangibleExplorationAndEvaluationAssets,@SupplierAD),
--(55,@MiningAssets,@SupplierAD),
--(60,@OilAndGasAssets,@SupplierAD),
--(65,@OwneroccupiedPropertyMeasuredUsingInvestmentPropertyFairValueModel,@SupplierAD),
--(70,@OtherPropertyPlantAndEquipment,@SupplierAD),

--(80,@BrandNames,@SupplierAD),
--(85,@IntangibleExplorationAndEvaluationAssets,@SupplierAD),
--(90,@MastheadsAndPublishingTitles,@SupplierAD),
--(95,@ComputerSoftware,@SupplierAD),
--(100,@LicencesAndFranchises,@SupplierAD),
--(105,@CopyrightsPatentsAndOtherIndustrialPropertyRightsServiceAndOperatingRights,@SupplierAD),
--(110,@RecipesFormulaeModelsDesignsAndPrototypes,@SupplierAD),
--(115,@IntangibleAssetsUnderDevelopment,@SupplierAD),
--(120,@OtherIntangibleAssets,@SupplierAD),

--(165,@Merchandise,@SupplierAD),
--(170,@CurrentFoodAndBeverage,@SupplierAD),
--(185,@PropertyIntendedForSaleInOrdinaryCourseOfBusiness,@SupplierAD),
--(190,@RawMaterials,@SupplierAD),
--(195,@ProductionSupplies,@SupplierAD),
--(200,@CurrentPackagingAndStorageMaterials,@SupplierAD),
--(205,@SpareParts,@SupplierAD),
--(210,@CurrentFuel,@SupplierAD),
--(215,@CurrentInventoriesInTransit,@SupplierAD),
--(220,@OtherInventories,@SupplierAD),
...
-- STAAAHHHHP: Customer is Agent or NOTED Agent? @ Soreti, it is Agent
--(1070,@RevenueFromSaleOfGoods,@CustomerAD),
--(1073,@RevenueFromSaleOfCopper,@CustomerAD),
--(1076,@RevenueFromSaleOfGold,@CustomerAD),
--(1079,@RevenueFromSaleOfSilver,@CustomerAD),
--(1082,@RevenueFromSaleOfOilAndGasProducts,@CustomerAD),
--(1085,@RevenueFromSaleOfCrudeOil,@CustomerAD),
--(1088,@RevenueFromSaleOfAgriculturalProduce,@CustomerAD),
--(1091,@RevenueFromSaleOfFoodAndBeverage,@CustomerAD),
--(1094,@RevenueFromRenderingOfTelecommunicationServices,@CustomerAD),
--(1097,@RevenueFromRenderingOfTransportServices,@CustomerAD),
--(1100,@RevenueFromRenderingOfInformationTechnologyMaintenanceAndSupportServices,@CustomerAD),
--(1103,@RevenueFromRenderingOfInformationTechnologyConsultingServices,@CustomerAD),
--(1106,@RevenueFromHotelOperations,@CustomerAD),
--(1109,@RevenueFromRoomOccupancyServices,@CustomerAD),
--(1112,@RevenueFromRenderingOfOtherPointOfTimeServicesExtension,@CustomerAD),
--(1115,@RevenueFromRenderingOfOtherPeriodOfTimeServicesExtension,@CustomerAD),
--(1118,@RevenueFromConstructionContracts,@CustomerAD),
--(1121,@OtherRevenue,@CustomerAD),
...
(1175,@WagesAndSalaries,@EmployeeAD),
(1180,@SocialSecurityContributions,@EmployeeAD),
(1185,@OtherShorttermEmployeeBenefits,@SupplierAD),
(1186,@OtherShorttermEmployeeBenefits,@EmployeeAD),
(1190,@PostemploymentBenefitExpenseDefinedContributionPlans,@EmployeeAD),
(1195,@PostemploymentBenefitExpenseDefinedBenefitPlans,@EmployeeAD),
(1200,@TerminationBenefitsExpense,@EmployeeAD),
(1201,@TerminationBenefitsExpense,@SupplierAD),
(1205,@OtherLongtermBenefits,@EmployeeAD),
...
(1235,@CustomerPerformanceObligationsOverAPeriodOfTimeControlExtension,@CustomerAD),
(1240,@EmployeePerformanceObligationsOverAPeriodOfTimeControlExtension,@EmployeeAD),
