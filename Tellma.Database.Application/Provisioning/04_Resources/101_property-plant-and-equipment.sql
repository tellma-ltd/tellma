...
--	Defining computer equipment	 @CostOfSales @DistributionCosts @AdministrativeExpense @ProductionExtension @ServiceExtension @OtherExpenseByFunction
	...
	(0,	@USD,		@AdministrativeExpense,	@C101_EXEC,	N'Microsoft Surface Pro (899 GBP)',	N'FZ889123',	dbo.fn_Lookup(@it_equipment_manufacturersDef, N'Microsoft'),dbo.fn_Lookup(@operating_systemsDef, N'Windows 10')),
	(1,	@USD,		@DistributionCosts,		@C101_Sales,N'Lenovo Laptop',					N'SS9898224',	dbo.fn_Lookup(@it_equipment_manufacturersDef, N'Lenovo'),	dbo.fn_Lookup(@operating_systemsDef, N'Windows 10')),
	(2,	@USD,		@DistributionCosts,		@C101_Campus,N'Lenovo Ideapad S145',			N'100022311',	dbo.fn_Lookup(@it_equipment_manufacturersDef, N'Lenovo'),	dbo.fn_Lookup(@operating_systemsDef, N'Windows 10')),
	(3,	@USD,		@ProductionExtension,	@C101_B10,	N'Abdulrahman Used Laptop',			N'100022312',	NULL,														dbo.fn_Lookup(@operating_systemsDef, N'Windows 10'));
