...
--		(N'RawMaterials',					N'Raw materials',								N'/1/11/1/1/',	1,29),
	...
	INSERT INTO @Resources ([Index],
		[AccountTypeId],						[Name],				[Code],			[Identifier], 	[Lookup1Id]) VALUES
	(0, dbo.fn_ATCode__Id(N'HotRollExtension'),	N'HR 1000MMx1.9MM',	N'HR1000x1.9',	N'1001',		dbo.fn_Lookup(N'steel-thicknesses', N'1.9')),
	(1, dbo.fn_ATCode__Id(N'ColdRollExtension'),N'CR 1000MMx1.4MM',	N'CR1000x1.4',	N'1002',		dbo.fn_Lookup(N'steel-thicknesses', N'1.4'));
