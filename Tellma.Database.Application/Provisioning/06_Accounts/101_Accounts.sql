...
*/
	...
	(11,N'12002',@OfficeEquipment,				@NonCurrentAssets_AC,	NULL,					@OfficeEquipment,		N'Office equipment',			@USD,			NULL,			@PPEAdditions,		NULL),
	(12,N'12003',@OfficeEquipment,				@NonCurrentAssets_AC,	NULL,					@OfficeEquipment,		N'Comp. equip. & acc.',			@USD,			NULL,			@PPEAdditions,		NULL),
	...
	(311,N'12012',@OfficeEquipment,				@NonCurrentAssets_AC,	NULL,					@OfficeEquipment,		N'Acc. Dep.- Office equipment',	@USD,			NULL,			@PPEDepreciations,	NULL),
	(312,N'12013',@OfficeEquipment,				@NonCurrentAssets_AC,	NULL,					@OfficeEquipment,		N'Acc. Dep.- Comp. equip. & acc.',@USD,			NULL,			@PPEDepreciations,	NULL),
...
--	(28,N'11206',@TradeAndOtherCurrentReceivables,@Debtors_AC,		@TradeAndOtherCurrentReceivables,	N'Commissions',					@USD,			@C101_INV,		NULL,				NULL),
	...
	(45,N'11121',@BalancesWithBanks,			@BankAndCash_AC,		@BalancesWithBanks,		NULL,					N'Bank Of Khartoum - SDG',		@SDG,			@C101_INV,		NULL,				@KRTBank),
