...
BEGIN
	...
	-- Assets Accounts
	(0,1,0,N'PPE',	@PropertyPlantAndEquipment,	N'Property, plant and equipment',@USD,		@RC_Inv,					NULL,			N'cost-objects',	NULL),

	(1,1,0,NULL,	@CashAndCashEquivalents,	N'GM Fund',					NULL,			@RC_Inv,					NULL,			N'cash-custodians',	@GMSafe),
	(2,1,0,NULL,	@CashAndCashEquivalents,	N'KSA Fund',				NULL,			@RC_Inv,					NULL,			N'cash-custodians',	@KSASafe),
