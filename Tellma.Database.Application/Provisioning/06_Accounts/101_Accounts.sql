...
--	(28,N'11206',@general_BSADef,@Debtors_AC,		@TradeAndOtherCurrentReceivables,	N'Commissions',					@USD,			@C101_INV,		NULL,				NULL),
	...
	(41,N'11111',@cashADef,		@BankAndCash_AC,	@CashOnHand,						N'GM Fund',						NULL,			@C101_INV,		NULL,				@GMSafe),
--	(42,N'11112',@cashADef,		@BankAndCash_AC,	@CashOnHand,						N'GM Fund - USD',				@USD,			@C101_INV,		NULL,				@GMSafe),
	(43,N'11113',@cashADef,		@BankAndCash_AC,	@CashOnHand,						N'Admin Fund - SDG',			@SDG,			@C101_INV,		NULL,				@AdminPettyCash),
...
*/
	...
	(91,N'40001',@revenueADef,	@Revenue_AC,		@RevenueFromRenderingOfServices,	N'Revenues - B10 - USD',		@USD,			@C101_B10,		NULL,				NULL),
	(92,N'40002',@revenueADef,	@Revenue_AC,		@RevenueFromRenderingOfServices,	N'Revenues - BSmart - USD',		@USD,			@C101_BSmart,	NULL,				NULL),
	(93,N'40003',@revenueADef,	@Revenue_AC,		@RevenueFromRenderingOfServices,	N'Revenues - BSmart - SDG',		@SDG,			@C101_BSmart,	NULL,				NULL),
	(94,N'40004',@revenueADef,	@Revenue_AC,		@RevenueFromRenderingOfServices,	N'Revenues - Campus - USD',		@USD,			@C101_Campus,	NULL,				NULL),
	(95,N'40005',@revenueADef,	@Revenue_AC,		@RevenueFromRenderingOfServices,	N'Revenues - Tellma - USD',		@USD,			@C101_Tellma,	NULL,				NULL),
	(99,N'40005',@revenueADef,	@Revenue_AC,		@OtherRevenue,						N'Rental Income - SAR',			@SAR,			@C101_FFLR,		NULL,				NULL),
