...
BEGIN
	...
	(3,1,1,@CurrentInventoriesInTransit,	N'Inventory',				@Inventories_AC,		N'TF1903950009',		N'بضاعة في الطريق',	N'1209', N'SAR',		@RC5_Exec,				NULL,			NULL,				NULL,		NULL), -- Merchandise in transit, for given LC
	(4,1,1,@Merchandise,					N'Inventory',				@Inventories_AC,		N'Paper Warehouse',		N'مخزون الورق',			N'1210', N'SAR',		@RC5_Exec,				NULL,			N'warehouses',		NULL,		NULL),
	...
	(6,1,0,@TradeAndOtherReceivables,		N'OtherCurrentAssets',		@Debtors_AC,			N'Prepaid Rental',		N'إيجار مقدم',			N'1401', N'SAR',		@RC5_Exec,				NULL,			N'suppliers',		NULL,		NULL),
