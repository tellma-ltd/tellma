...
(3100001, N'Paid up capital', N'310-0001', @IssuedCapital, @AC3100000),
(3200001, N'Retained Earning - Soreti', N'320-0001', @RetainedEarnings, @AC3200000),
(3400001, N'Revaluation surplus', N'340-0001', @RevaluationSurplus, @AC3400000),
(3400008, N'Reserve of gains and losses on financial assets measured at fair value through other comprehensive income', N'340-0008', @ReserveOfGainsAndLossesOnFinancialAssetsMeasuredAtFairValueThroughOtherComprehensiveIncome, @AC3400000),
(3400015, N'Amount recognised in other comprehensive income and accumulated in equity relating to non-current assets or disposal groups held for sale', N'340-0015', @AmountRecognisedInOtherComprehensiveIncomeAndAccumulatedInEquityRelatingToNoncurrentAssetsOrDisposalGroupsHeldForSale, @AC3400000),
(3400018, N'Reserve for catastrophe', N'340-0018', @ReserveForCatastrophe, @AC3400000),
(3400024, N'Statutory reserve', N'340-0024', @StatutoryReserve, @AC3400000),
(4111110, N'Revenue from Exported Grains - SP', N'4111-110', @RevenueFromSaleOfGoods, @AC4110000),
(4111120, N'Revenue from Processed Oil - SP', N'4111-120', @RevenueFromSaleOfGoods, @AC4110000),
(4111130, N'Revenue from Assembled Minidor - SP', N'4111-130', @RevenueFromSaleOfGoods, @AC4110000),
(4111140, N'Revenue from Imported Merchandise - SP', N'4111-140', @RevenueFromSaleOfGoods, @AC4110000),
(4111150, N'Revenue from Local Grains - SP', N'4111-150', @RevenueFromSaleOfGoods, @AC4110000),
(4111190, N'Revenue from other Trading Activities', N'4111-190', @RevenueFromSaleOfGoods, @AC4110000),
(4121210, N'Revenue from Soreti Mall - SP', N'4121-210', @RevenueFromRenderingOfServices, @AC4120000),
(4121220, N'Revenue from A.A. Building - SP', N'4121-220', @RevenueFromRenderingOfServices, @AC4120000),
...
(5311210, N'Insurance Expense - Soreti Mall', N'5311-210', @InsuranceExpense, @AC),
(5311220, N'Insurance Expense - Bole HQ', N'5311-220', @InsuranceExpense, @AC),
(5313010, N'Insurance Expense - Adama Factory', N'5313-010', @InsuranceExpense, @AC),
(5313020, N'Insurance Expense - Minidor Factory', N'5313-020', @InsuranceExpense, @AC),
(5411111, N'Wages and Salaries - Exported Grains', N'5411-111', @WagesAndSalaries, @AC),
(5411112, N'Wages and Salaries - Processed Oil', N'5411-112', @WagesAndSalaries, @AC),
(5411113, N'Wages And Salaries - Assembled Minidor', N'5411-113', @WagesAndSalaries, @AC),
(5411114, N'Wages And Salaries - Imported Merchandise', N'5411-114', @WagesAndSalaries, @AC),
(5411115, N'Wages and Salaries - Local Grains', N'5411-115', @WagesAndSalaries, @AC),
(5411119, N'Wages and Salaries - other Trading Activities', N'5411-119', @WagesAndSalaries, @AC),
(5411121, N'Wages and Salaries - Soreti Mall', N'5411-121', @WagesAndSalaries, @AC),
(5411122, N'Wages and Salaries - Addis Ababa Building', N'5411-122', @WagesAndSalaries, @AC),
(5411201, N'Wages and Salaries - Bole HQ - SGNA', N'5411-201', @WagesAndSalaries, @AC),
(5411301, N'Wages and Salaries - Adama Factory', N'5411-301', @WagesAndSalaries, @AC),
(5411302, N'Wages and Salaries - Minidor Factory', N'5411-302', @WagesAndSalaries, @AC)
