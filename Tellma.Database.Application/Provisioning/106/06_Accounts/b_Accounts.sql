...
(4, N'1101-101', N'Petty Cash - Bizunesh Birhanu', @CashOnHand, @CashOnHandAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(6, N'1102-101', N'Petty Cash - Amanuel Bayissa', @CashOnHand, @CashOnHandAccountCD, NULL, @ETB,@106C_Rental,NULL),
(8, N'1103-001', N'AIB Bole OD', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(9, N'1103-002', N'AIB Bole Special OD', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(10, N'1103-003', N'ECX AIB Bole Payout', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(11, N'1103-004', N'ECX AIB Bole Payin', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(12, N'1103-005', N'AIB Bole Current Account', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(13, N'1103-006', N'AIB Main', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(14, N'1103-007', N'AIB Dembela', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(15, N'1103-008', N'AIB Derartu Adebabay', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(16, N'1103-009', N'AIB 10% Retention', @BalancesWithBanks, @BankAccountCD, NULL, @USD,@106C_HeadOfficeSegment,NULL),
(17, N'1103-010', N'AIB 90% Retention', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(18, N'1103-011', N'OIB Hora (Import)72035/1070502', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(19, N'1103-012', N'OIB Hora Current Account', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(20, N'1103-013', N'OIB Boset 23833/2010101/1/0', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(21, N'1103-014', N'OIB ECX Commission', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(22, N'1103-015', N'OIB ECX Payin', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(23, N'1103-016', N'OIB 10% Retention', @BalancesWithBanks, @BankAccountCD, NULL, @USD,@106C_HeadOfficeSegment,NULL),
(24, N'1103-017', N'OIB 90% Retention', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(25, N'1103-018', N'OIBAdama 23833/2010101/16/0', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(26, N'1103-019', N'OIB Biftu 692369', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(27, N'1103-020', N'OIB Boset', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(28, N'1103-021', N'OIB Boset 10% 2011001/1/0', @BalancesWithBanks, @BankAccountCD, NULL, @USD,@106C_HeadOfficeSegment,NULL),
(29, N'1103-022', N'OIB Boset 90% 2011201/1/0', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(30, N'1103-023', N'OIB Interest free Adama', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(31, N'1103-024', N'CBE A/Avenu', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(32, N'1103-025', N'CBE OUTSTANDING BALANCE', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(33, N'1103-026', N'OIB 82397', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(34, N'1103-027', N'CBE A/Avenu Pay out', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(35, N'1103-028', N'CBE A/Avenu Payin', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(36, N'1103-029', N'CBE 10% Retention', @BalancesWithBanks, @BankAccountCD, NULL, @USD,@106C_HeadOfficeSegment,NULL),
(37, N'1103-030', N'CBE 90% Retention', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(38, N'1103-031', N'CBE 90% Old Retention', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(39, N'1103-032', N'CBE A.A', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(40, N'1103-033', N'CBE Andnet', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(41, N'1103-034', N'CBE Abageda', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(42, N'1103-035', N'Cooprativ Bank Finfine', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(43, N'1103-036', N'Cooprativ Bank Adama', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(44, N'1103-037', N'Cooprativ Bank Hawass', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(45, N'1103-038', N'Cooprativ Bank 10% Retention', @BalancesWithBanks, @BankAccountCD, NULL, @USD,@106C_HeadOfficeSegment,NULL),
(46, N'1103-039', N'Cooprativ Bank 90% Retention', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(47, N'1103-040', N'Nib Bole', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(48, N'1103-041', N'Nib 10% Retention', @BalancesWithBanks, @BankAccountCD, NULL, @USD,@106C_HeadOfficeSegment,NULL),
(49, N'1103-042', N'Nib 90% Retention', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(50, N'1103-043', N'Dashen Bank', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(51, N'1103-044', N'Wegagen Bank A/Avenu', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(52, N'1103-045', N'Wegagen Bank Adama', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(53, N'1103-046', N'United Bank', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(54, N'1103-047', N'Zemen Bank', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(55, N'1103-048', N'OIB Loan Hor 72035/1070402/1/0', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(56, N'1103-049', N'OIB Hora 72035/2010101/1/0', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(57, N'1103-050', N'OibInt.fr Hora 27827/2010101/1', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(58, N'1103-051', N'Cooperative Finfinie Br/3747', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(59, N'1103-052', N'Cooperativ Bole Rwanda53532644', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(60, N'1103-053', N'Debub Global', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(61, N'1103-054', N'Abyssinia Bank Air Port Branch', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(62, N'1103-055', N'Abyssinya Bank of Abageda', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(63, N'1103-056', N'Aib Denbela', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(64, N'1103-057', N'CBE Nathret Branch', @BalancesWithBanks, @BankAccountCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(67, N'1121-010', N'Trade Receivables', @CurrentTradeReceivables, @CustomerCD, NULL, @ETB,@106C_TradingSegment,NULL),
(68, N'1121-020', N'Receivables due from related parties', @TradeAndOtherCurrentReceivablesDueFromRelatedParties, @CustomerCD, NULL, @ETB,@106C_TradingSegment,NULL),
(69, N'1121-030', N'Prepayments', @CurrentPrepayments, @SupplierCD, NULL, @ETB,@106C_TradingSegment,NULL),
(70, N'1121-040', N'Accrued Income', @CurrentAccruedIncome, @CustomerCD, NULL, @ETB,@106C_TradingSegment,NULL),
(71, N'1121-050', N'Rent Receivables', @CurrentReceivablesFromRentalOfProperties, @CustomerCD, NULL, @ETB,@106C_RealEstateSegment,NULL),
(73, N'1206-001', N'VAT Receivables', @CurrentValueAddedTaxReceivables, NULL, NULL, @ETB,@106C_HeadOfficeSegment,@CustomerCD),
(74, N'1206-002', N'Withholding tax Receivables', @WithholdingTaxReceivablesExtension, NULL, NULL, @ETB,@106C_HeadOfficeSegment,@SupplierCD),
(76, N'1204-010', N'Deposit Bid Bond', @OtherCurrentReceivables, NULL, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(78, N'1202-010', N'Staff Debtors', @OtherCurrentFinancialAssets, @EmployeeCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
(79, N'1205-010', N'Sundry Debtors', @OtherCurrentFinancialAssets, @DebtorCD, NULL, @ETB,@106C_HeadOfficeSegment,NULL),
...
(86, N'1401-001', N'Fava beans', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(87, N'1401-002', N'White Pea beans', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(88, N'1401-003', N'Red Kidney beans', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(89, N'1401-004', N'Cream beans', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(90, N'1401-005', N'Light Speckled beans', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(91, N'1401-006', N'Black beans', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(92, N'1401-007', N'Light brown', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(93, N'1401-013', N'Green Mung beans', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(94, N'1401-016', N'Chickpeas', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(95, N'1401-017', N'Kabuli Chickpeas', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(96, N'1401-020', N'Soya beans', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(98, N'1401-021', N'Sesame Seeds', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(99, N'1401-022', N'Sunflower Seeds', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(100, N'1401-023', N'Linseeds', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(103, N'1401-030', N'Maize', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(104, N'1401-032', N'Wheat', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(105, N'1401-033', N'Barley', @RawMaterials, @WarehouseCD, @RawGrainRD, @ETB,@106C_TradingSegment,NULL),
(108, N'1402-001', N'White Pea beans', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(109, N'1402-002', N'Red Kidney beans', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(110, N'1402-003', N'Chickpeas', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(111, N'1402-004', N'Cream (Kidney) beans', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(112, N'1402-005', N'Soya beans', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(113, N'1402-006', N'Light Speckled (Kidney) beans', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(114, N'1402-007', N'Chick beans', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(115, N'1402-008', N'Black (Kidney) beans', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(116, N'1402-009', N'Light Brown (Kidney) beans', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(117, N'1402-010', N'Green Mung beans', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(118, N'1402-011', N'Kabuli Chickpeas', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(120, N'1402-021', N'Sesame Seeds', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(121, N'1402-022', N'Sunflower Seeds', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(122, N'1402-023', N'Linseeds', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(123, N'1402-024', N'Fava beans', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(125, N'1402-031', N'Maize', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(126, N'1402-032', N'Wheat', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(127, N'1402-033', N'Barley', @FinishedGoods, @WarehouseCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(129, N'1403-001', N'White Pea beans', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(130, N'1403-002', N'Red Kidney beans', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(131, N'1403-003', N'Chickpeas', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(132, N'1403-004', N'Cream beans', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(133, N'1403-005', N'Soya beans', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(134, N'1403-006', N'Light Speckled beans', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(135, N'1403-007', N'Chick beans', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(136, N'1403-008', N'Black beans', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(137, N'1403-009', N'Light brown', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(138, N'1403-010', N'Green Mung beans', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(139, N'1403-011', N'Kabuli Chickpeas', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(140, N'1403-012', N'Sesame Seeds', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(141, N'1403-013', N'Sunflower Seeds', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(142, N'1403-014', N'Linseeds', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(143, N'1403-015', N'Fava beans', @OtherInventories, @WarehouseCD, @ByproductGrainRD, @ETB,@106C_TradingSegment,NULL),
(145, N'1404-001', N'Minidor Assembled', @FinishedGoods, @WarehouseCD, @FinishedVehicleRD, @ETB,@106C_TradingSegment,NULL),
(147, N'1405-001', N'Oli Oil', @FinishedGoods, @WarehouseCD, @FinishedOilRD, @ETB,@106C_TradingSegment,NULL),
(149, N'1406-001', N'Oil cake', @OtherInventories, @WarehouseCD, @ByproductOilRD, @ETB,@106C_TradingSegment,NULL),
(155, N'1409-001,-002,etc', N'By major groups', @RawMaterials, @WarehouseCD, NULL, @ETB,@106C_TradingSegment,NULL),
(157, N'1410-001', N'Sunflower', @RawMaterials, @WarehouseCD, @RawOilRD, @ETB,@106C_TradingSegment,NULL),
(159, N'1411-001', N'Minidor (SKD)', @Merchandise, @WarehouseCD, NULL, @ETB,@106C_TradingSegment,NULL),
(161, N'1412-001', N'Oil imported', @Merchandise, @WarehouseCD, NULL, @ETB,@106C_TradingSegment,NULL),
(163, N'1413-001,002, etc', N'By major type of Spare parts', @Merchandise, @WarehouseCD, NULL, @ETB,@106C_TradingSegment,NULL),
(165, N'14014-001,002, etc', N'By major type of Medicine', @Merchandise, @WarehouseCD, @MedicineRD, @ETB,@106C_TradingSegment,NULL),
(167, N'1415-001,002, etc', N'By major type of Construction materials', @Merchandise, @WarehouseCD, @ConstructionMaterialRD, @ETB,@106C_TradingSegment,NULL),
(169, N'1416-001', N'PP bags & thread', @CurrentPackagingAndStorageMaterials, @WarehouseCD, NULL, @ETB,@106C_TradingSegment,NULL),
(170, N'1416-002', N'Plastic Bottle of Oil', @CurrentPackagingAndStorageMaterials, @WarehouseCD, NULL, @ETB,@106C_TradingSegment,NULL),
(171, N'1416-003', N'Containers & Other packing materials', @CurrentPackagingAndStorageMaterials, @WarehouseCD, NULL, @ETB,@106C_TradingSegment,NULL),
(173, N'1417-001,002, etc', N'By type of Oil, Fuel & Lubricants', @CurrentFuel, @WarehouseCD, NULL, @ETB,@106C_TradingSegment,NULL),
(175, N'1418-001', N'Other consumable goods', @OtherInventories, @WarehouseCD, NULL, @ETB,@106C_TradingSegment,NULL),
(176, N'1418-002', N'Other Fumigation materials', @OtherInventories, @WarehouseCD, NULL, @ETB,@106C_TradingSegment,NULL),
(177, N'1418-003', N'Uniform & Outfit', @OtherInventories, @WarehouseCD, NULL, @ETB,@106C_TradingSegment,NULL),
(178, N'1418-004', N'Electrical Materials', @OtherInventories, @WarehouseCD, NULL, @ETB,@106C_TradingSegment,NULL),
(179, N'1418-005', N'Other mateirals', @OtherInventories, @WarehouseCD, NULL, @ETB,@106C_TradingSegment,NULL),
(181, N'1419-001,002, etc ', N'By type of medicine', @OtherInventories, @WarehouseCD, @MedicineRD, @ETB,@106C_TradingSegment,NULL),
(185, N'1430-001', N'Vehcile /Minidor L/C # …..', @CurrentInventoriesInTransit, @ImportShipmentCD, NULL, @ETB,@106C_TradingSegment,NULL),
(186, N'1430-002', N'Vehcile Spare parts L/C # …..', @CurrentInventoriesInTransit, @ImportShipmentCD, NULL, @ETB,@106C_TradingSegment,NULL),
(187, N'1430-003', N'Oil L/C #', @CurrentInventoriesInTransit, @ImportShipmentCD, NULL, @ETB,@106C_TradingSegment,NULL),
(188, N'1430-004', N'Machinery L/C #', @CurrentInventoriesInTransit, @ImportShipmentCD, NULL, @ETB,@106C_TradingSegment,NULL),
(189, N'1430-005', N'Machinery spare parts L/C #', @CurrentInventoriesInTransit, @ImportShipmentCD, NULL, @ETB,@106C_TradingSegment,NULL),
(190, N'1430-006', N'Stationery materials L/C #', @CurrentInventoriesInTransit, @ImportShipmentCD, NULL, @ETB,@106C_TradingSegment,NULL),
(191, N'1430-007', N'Sanitation materials L/C #', @CurrentInventoriesInTransit, @ImportShipmentCD, NULL, @ETB,@106C_TradingSegment,NULL),
(192, N'1430-008', N'Medicine', @CurrentInventoriesInTransit, @ImportShipmentCD, @MedicineRD, @ETB,@106C_TradingSegment,NULL),
(193, N'1430-009', N'Other Imported Goods L/C #', @CurrentInventoriesInTransit, @ImportShipmentCD, NULL, @ETB,@106C_TradingSegment,NULL),
(196, N'1431-001', N'White Pea beans,  permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(197, N'1431-002', N'Red Kidney beans , Permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(198, N'1431-003', N'Chickpeas, permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(199, N'1431-004', N'Cream beans, permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(200, N'1431-005', N'Soya beans, permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(201, N'1431-006', N'Light Speckled beans, permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(202, N'1431-007', N'Chick beans, permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(203, N'1431-008', N'Black beans, permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(204, N'1431-009', N'Light brown, permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(205, N'1431-010', N'Green Mung beans, permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(206, N'1431-011', N'Kabuli Chickpeas, permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(208, N'1431-021', N'Sesame Seeds, permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(209, N'1431-022', N'Sunflower Seeds, permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
(210, N'1431-023', N'Linseeds, permit #', @CurrentInventoriesInTransit, @ExportShipmentCD, @FinishedGrainRD, @ETB,@106C_TradingSegment,NULL),
...
(279, N'2101-001,002,etc', N'By the name of Trade Creditor', @TradeAndOtherCurrentPayablesToTradeSuppliers, @SupplierCD, NULL, @ETB,@106C_TradingSegment,NULL),
...
(288, N'2301-001', N'Personal Tax Payable', @CurrentEmployeeIncomeTaxPayablesExtension, NULL, NULL, @ETB,NULL,@EmployeeCD),
(289, N'2301-002', N'VAT Payables', @CurrentValueAddedTaxPayables, NULL, NULL, @ETB,NULL,@CustomerCD),
(294, N'2301-007', N'Excise tax Payable ', @CurrentExciseTaxPayables, NULL, NULL, @ETB,@106C_TradingSegment,NULL),
(297, N'2401-001, 002, etc ', N'By the name of Contractor', @CurrentRetentionPayables, @SupplierCD, NULL, @ETB,@106C_RealEstateSegment,NULL),
...
(300, N'2402-002', N'Accrued Payroll Payable', @AccrualsClassifiedAsCurrent, @EmployeeCD, NULL, @ETB,NULL,NULL),
(301, N'2402-003', N'Accrued Leave & Severance Pay', @AccrualsClassifiedAsCurrent, @EmployeeCD, NULL, @ETB,NULL,NULL),
