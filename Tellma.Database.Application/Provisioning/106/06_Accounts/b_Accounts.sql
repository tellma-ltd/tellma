...
(11111, N'Cash Account 1', N'111-11', @CashOnHand, @AC111, @ETB,@106C_Soreti,NULL,@CashOnHandAccountCD),
(11112, N'Cash Account 2', N'111-12', @CashOnHand, @AC111, @ETB,@106C_Soreti,NULL,@CashOnHandAccountCD),
(11113, N'Cash Account 3', N'111-13', @CashOnHand, @AC111, @ETB,@106C_Soreti,NULL,@CashOnHandAccountCD),
(11114, N'Cash Account 4', N'111-14', @CashOnHand, @AC111, @ETB,@106C_Soreti,NULL,@CashOnHandAccountCD),
(11121, N'Bank Account 1', N'111-21', @BalancesWithBanks, @AC111, @ETB,@106C_Soreti,NULL,@BankAccountCD),
(11122, N'Bank Account 2', N'111-22', @BalancesWithBanks, @AC111, @USD,@106C_Soreti,NULL,@BankAccountCD),
(11123, N'Bank Account 3', N'111-23', @BalancesWithBanks, @AC111, @ETB,@106C_Soreti,NULL,@BankAccountCD),
(11124, N'Bank Account 4', N'111-24', @BalancesWithBanks, @AC111, @ETB,@106C_Soreti,NULL,@BankAccountCD),
(11210, N'Current trade receivable', N'112-10', @CurrentTradeReceivables, @AC112, @ETB,@106C_Soreti,NULL,@CustomerCD),
(11220, N'Current receivable from related parties', N'112-20', @TradeAndOtherCurrentReceivablesDueFromRelatedParties, @AC112, @ETB,@106C_Soreti,NULL,@CustomerCD),
(11230, N'Current prepayments', N'112-30', @CurrentPrepayments, @AC112, @ETB,@106C_Soreti,NULL,@SupplierCD),
(11240, N'Current accrued income', N'112-40', @CurrentAccruedIncome, @AC112, @ETB,@106C_Soreti,NULL,@CustomerCD),
(11250, N'Current billed but not received', N'112-50', @CurrentBilledButNotReceivedExtension, @AC112, @ETB,@106C_Soreti,NULL,@SupplierCD),
(11299, N'ECL Allowance, Billed but not received', N'112-99', @CurrentBilledButNotReceivedExtension, @AC112, @ETB,@106C_Soreti,NULL,NULL),
(11301, N'VAT Receivable', N'113-01', @CurrentValueAddedTaxReceivables, @AC113, @ETB,@106C_Soreti,NULL,NULL),
(11302, N'WT Receivable', N'113-02', @WithholdingTaxReceivablesExtension, @AC113, @ETB,@106C_Soreti,NULL,NULL),
(11303, N'Current tax assets, current', N'113-03', @CurrentTaxAssetsCurrent, @AC113, @ETB,@106C_Soreti,NULL,NULL),
(11400, N'Rental Receivables', N'114-00', @CurrentReceivablesFromRentalOfProperties, @AC114, @ETB,@106C_Soreti,NULL,@CustomerCD),
(11499, N'ECL Allowance, Rental Receivable', N'114-99', @CurrentReceivablesFromRentalOfProperties, @AC114, @ETB,@106C_Soreti,NULL,NULL),
(11510, N'Staff Loans', N'115-10', @StaffDebtorsExtension, @AC115, @ETB,@106C_Soreti,NULL,@EmployeeCD),
(11520, N'Salary Advances', N'115-20', @StaffDebtorsExtension, @AC115, @ETB,@106C_Soreti,NULL,@EmployeeCD),
(11530, N'Temporary Petty Cash', N'115-30', @StaffDebtorsExtension, @AC115, @ETB,@106C_Soreti,NULL,@EmployeeCD),
(11540, N'Travel Petty Cash - USD', N'115-40', @StaffDebtorsExtension, @AC115, @USD,@106C_Soreti,NULL,@EmployeeCD),
(11599, N'Allowance for ECL, Staff debtors', N'115-99', @StaffDebtorsExtension, @AC115, @ETB,@106C_Soreti,NULL,NULL),
(11600, N'Sundry Debtors', N'116-00', @SundryDebtorsExtension, @AC116, @ETB,@106C_Soreti,NULL,@DebtorCD),
(11601, N'Sundry Debtor 1 - Trading', N'116-01', @SundryDebtorsExtension, @AC116, @ETB,@106C_Soreti,NULL,@DebtorCD),
(11602, N'Sundry Debtor 2 - Trading', N'116-02', @SundryDebtorsExtension, @AC116, @ETB,@106C_Soreti,NULL,@DebtorCD),
(11699, N'Allowance for ECL, Sundry debtors', N'116-99', @SundryDebtorsExtension, @AC116, @ETB,@106C_Soreti,NULL,NULL),
(11711, N'Cleaned Grains', N'117-11', @CurrentInventoriesHeldForSale, @AC117, @ETB,@106C_Soreti,@FinishedGrainRD,@WarehouseCD),
(11712, N'Rejected Grains', N'117-12', @CurrentInventoriesHeldForSale, @AC117, @ETB,@106C_Soreti,@ByproductGrainRD,@WarehouseCD),
(11713, N'Medicine', N'117-13', @CurrentInventoriesHeldForSale, @AC117, @USD,@106C_Soreti,@TradeMedicineRD,@WarehouseCD),
(11714, N'Construction Materials', N'117-14', @CurrentInventoriesHeldForSale, @AC117, @USD,@106C_Soreti,@TradeConstructionMaterialRD,@WarehouseCD),
(11715, N'Spare Parts (for Sale)', N'117-15', @CurrentInventoriesHeldForSale, @AC117, @USD,@106C_Soreti,@TradeSparePartRD,@WarehouseCD),
(11717, N'Processed Oil', N'117-17', @CurrentInventoriesHeldForSale, @AC117, @ETB,@106C_Soreti,@FinishedOilRD,@WarehouseCD),
(11718, N'Oil Cake', N'117-18', @CurrentInventoriesHeldForSale, @AC117, @ETB,@106C_Soreti,@ByproductOilRD,@WarehouseCD),
(11719, N'Assembled Vehicles', N'117-19', @CurrentInventoriesHeldForSale, @AC117, @USD,@106C_Soreti,@FinishedVehicleRD,@WarehouseCD),
(11741, N'Oils in Process', N'117-41', @WorkInProgress, @AC117, @ETB,@106C_Site1OilMilling,@WorkInProgressRD,NULL),
(11742, N'Vehicles in Process', N'117-42', @WorkInProgress, @AC117, @USD,@106C_MinidorLine,@WorkInProgressRD,NULL),
(11751, N'Raw Grains', N'117-51', @CurrentMaterialsAndSuppliesToBeConsumedInProductionProcessOrRenderingServices, @AC117, @ETB,@106C_Soreti,@RawGrainRD,@WarehouseCD),
(11752, N'Vehicle Components', N'117-52', @CurrentMaterialsAndSuppliesToBeConsumedInProductionProcessOrRenderingServices, @AC117, @USD,@106C_Soreti,@RawVehicleRD,@WarehouseCD),
(11753, N'Packaging and Storage Materials ', N'117-53', @CurrentMaterialsAndSuppliesToBeConsumedInProductionProcessOrRenderingServices, @AC117, NULL,@106C_Soreti,NULL,@WarehouseCD),
(11754, N'Spare Parts (Maintenance)', N'117-54', @CurrentMaterialsAndSuppliesToBeConsumedInProductionProcessOrRenderingServices, @AC117, NULL,@106C_Soreti,NULL,@WarehouseCD),
(11791, N'Import shipments', N'117-91', @CurrentInventoriesInTransit, @AC117, @USD,NULL,NULL,NULL),
(11792, N'Export shipments', N'117-92', @CurrentInventoriesInTransit, @AC117, @ETB,NULL,@FinishedGrainRD,NULL),
(11799, N'Other current inventories', N'117-99', @OtherInventories, @AC117, NULL,@106C_Soreti,NULL,NULL),
(12111, N'Land', N'121-11', @Land, @AC121, @ETB,NULL,@LandMemberRD,NULL),
(12112, N'Buildings', N'121-12', @Buildings, @AC121, @ETB,NULL,@BuildingsMemberRD,NULL),
(12113, N'Leasehold Improvements', N'121-13', @Buildings, @AC121, @ETB,NULL,@LeaseholdImprovementsMemberRD,NULL),
(12121, N'Machinery and Tools', N'121-21', @Machinery, @AC121, NULL,NULL,@MachineryMemberRD,NULL),
(12122, N'Laboratory Equipment', N'121-22', @Machinery, @AC121, NULL,NULL,NULL,NULL),
(12123, N'Power Generating Assets', N'121-23', @Machinery, @AC121, NULL,NULL,@PowerGeneratingAssetsMemberRD,NULL),
(12124, N'Fumigation Equipment', N'121-24', @Machinery, @AC121, NULL,NULL,NULL,NULL),
(12131, N'Vehicles', N'121-31', @Vehicles, @AC121, @ETB,NULL,@MotorVehiclesMemberRD,NULL),
(12141, N'Fixtures and fittings', N'121-41', @FixturesAndFittings, @AC121, NULL,NULL,NULL,NULL),
(12151, N'Office furniture', N'121-51', @OfficeEquipment, @AC121, NULL,NULL,@OfficeEquipmentMemberRD,NULL),
(12152, N'Computer equipment', N'121-52', @OfficeEquipment, @AC121, NULL,NULL,@ComputerEquipmentMemberRD,NULL),
(12171, N'Construction in progress', N'121-71', @ConstructionInProgress, @AC121, NULL,NULL,NULL,NULL),
(12181, N'Owner-occupied property', N'121-81', @OwneroccupiedPropertyMeasuredUsingInvestmentPropertyFairValueModel, @AC121, NULL,NULL,NULL,NULL),
(12191, N'Other property, plant and equipment', N'121-91', @OtherPropertyPlantAndEquipment, @AC121, NULL,NULL,NULL,NULL),
(12510, N'Non-current trade receivables', N'125-10', @NoncurrentTradeReceivables, @AC125, NULL,@106C_Soreti,NULL,@CustomerCD),
(12520, N'Non-current receivables due from related parties', N'125-20', @NoncurrentReceivablesDueFromRelatedParties, @AC125, NULL,@106C_Soreti,NULL,@CustomerCD),
(12530, N'Non-current prepayments', N'125-30', @NoncurrentPrepayments, @AC125, NULL,@106C_Soreti,NULL,@SupplierCD),
(12540, N'Non-current accrued income', N'125-40', @NoncurrentAccruedIncome, @AC125, NULL,@106C_Soreti,NULL,@CustomerCD),
(12550, N'Non-current receivables from taxes other than income tax', N'125-50', @NoncurrentReceivablesFromTaxesOtherThanIncomeTax, @AC125, NULL,@106C_Soreti,NULL,NULL),
(12560, N'Non-current receivables from rental of properties', N'125-60', @NoncurrentReceivablesFromRentalOfProperties, @AC125, NULL,@106C_Soreti,NULL,@CustomerCD),
(12570, N'Other non-current receivables', N'125-70', @OtherNoncurrentReceivables, @AC125, NULL,@106C_Soreti,NULL,NULL),
(21101, N'Current provisions for employees', N'211-01', @CurrentProvisionsForEmployeeBenefits, @AC211, NULL,@106C_Soreti,NULL,NULL),
(21111, N'Other current provisions', N'211-11', @OtherShorttermProvisions, @AC211, NULL,@106C_Soreti,NULL,NULL),
(21210, N'Current Trade Payables', N'212-10', @TradeAndOtherCurrentPayablesToTradeSuppliers, @AC212, @ETB,@106C_Soreti,NULL,@SupplierCD),
(21220, N'Current payables to related parties', N'212-20', @TradeAndOtherCurrentPayablesToRelatedParties, @AC212, @ETB,@106C_Soreti,NULL,@SupplierCD),
(21230, N'Current Deferred Income', N'212-30', @DeferredIncomeClassifiedAsCurrent, @AC212, @ETB,@106C_Soreti,NULL,@CustomerCD),
(21240, N'Accrued Expenses', N'212-40', @AccrualsClassifiedAsCurrent, @AC212, @ETB,@106C_Soreti,NULL,@SupplierCD),
(21250, N'Employee Benefit Accruals', N'212-50', @ShorttermEmployeeBenefitsAccruals, @AC212, @ETB,@106C_Soreti,NULL,@EmployeeCD),
(21260, N'Retention Payable', N'212-60', @CurrentRetentionPayables, @AC212, @ETB,@106C_Soreti,NULL,@SupplierCD),
(21301, N'Current value added tax payables', N'213-01', @CurrentValueAddedTaxPayables, @AC213, @ETB,@106C_Soreti,NULL,NULL),
(21302, N'Current excise tax payables', N'213-02', @CurrentExciseTaxPayables, @AC213, @ETB,@106C_Soreti,NULL,NULL),
(21303, N'Current Social Security payables', N'213-03', @CurrentSocialSecurityPayablesExtension, @AC213, @ETB,@106C_Soreti,NULL,NULL),
(21304, N'Provident fund payable', N'213-04', @ProvidentFundPayableExtension, @AC213, @ETB,@106C_Soreti,NULL,NULL),
(21305, N'Employee Income Tax Payable', N'213-05', @CurrentEmployeeIncomeTaxPayablesExtension, @AC213, @ETB,@106C_Soreti,NULL,NULL),
(21306, N'Witholding Tax Payable', N'213-06', @WithholdingTaxPayableExtension, @AC213, @ETB,@106C_Soreti,NULL,NULL),
(21307, N'Cost Sharing Payable', N'213-07', @CostSharingPayableExtension, @AC213, @ETB,@106C_Soreti,NULL,NULL),
(21308, N'Dividend Tax Payable', N'213-08', @DividendTaxPayableExtension, @AC213, @ETB,@106C_Soreti,NULL,NULL),
(21309, N'Profit tax payable', N'213-09', @CurrentTaxLiabilitiesCurrent, @AC213, @ETB,@106C_Soreti,NULL,NULL),
(21701, N'Sundry Creditor 1', N'217-01', @OtherCurrentFinancialLiabilities, @AC217, @ETB,@106C_Soreti,NULL,NULL),
(21702, N'Sundry Creditor 2', N'217-02', @OtherCurrentFinancialLiabilities, @AC217, @ETB,@106C_Soreti,NULL,NULL),
(21703, N'Short term bank loan', N'217-03', @OtherCurrentFinancialLiabilities, @AC217, @ETB,@106C_Soreti,NULL,NULL),
(21704, N'Interest free loan', N'217-04', @OtherCurrentFinancialLiabilities, @AC217, @ETB,@106C_Soreti,NULL,NULL),
(21705, N'Merchandise loan', N'217-05', @OtherCurrentFinancialLiabilities, @AC217, @ETB,@106C_Soreti,NULL,NULL),
(22101, N'Non-current provisions for employee benefits', N'221-01', @NoncurrentProvisionsForEmployeeBenefits, @AC221, NULL,@106C_Soreti,NULL,NULL),
(22102, N'Other non-current provisions', N'221-02', @OtherLongtermProvisions, @AC221, NULL,@106C_Soreti,NULL,NULL),
(22201, N'Deferred tax liabilities', N'222-01', @DeferredTaxLiabilities, @AC222, NULL,@106C_Soreti,NULL,NULL),
(22202, N'Current tax liabilities, non-current', N'222-02', @CurrentTaxLiabilitiesNoncurrent, @AC222, NULL,@106C_Soreti,NULL,NULL),
(22203, N'Other non-current financial liabilities', N'222-03', @OtherNoncurrentFinancialLiabilities, @AC222, NULL,@106C_Soreti,NULL,NULL),
(22204, N'Long term bank loan', N'222-04', @OtherNoncurrentFinancialLiabilities, @AC222, @ETB,@106C_Soreti,NULL,NULL),
(31110, N'Paid up capital', N'311-10', @IssuedCapital, @AC311, @ETB,@106C_Soreti,NULL,NULL),
(31210, N'Retained Earning - Soreti', N'312-10', @RetainedEarnings, @AC312, @ETB,@106C_Soreti,NULL,NULL),
(31220, N'P/L - Export', N'312-20', @RetainedEarnings, @AC312, @ETB,@106C_ExportCostofSales,NULL,NULL),
(31230, N'P/L - Import', N'312-30', @RetainedEarnings, @AC312, @ETB,@106C_ImportCostofsales,NULL,NULL),
(31240, N'P/L - Agro Processing', N'312-40', @RetainedEarnings, @AC312, @ETB,@106C_AgroProcessingCostofSales,NULL,NULL),
(31250, N'P/L - Manufacturing', N'312-50', @RetainedEarnings, @AC312, @ETB,@106C_ManufacturingCostofsales,NULL,NULL),
(31260, N'P/L - Local Trade', N'312-60', @RetainedEarnings, @AC312, @ETB,@106C_LocalTradeCostofSales,NULL,NULL),
(31270, N'P/L - Real Estate', N'312-70', @RetainedEarnings, @AC312, @ETB,@106C_SoretiMallCostofsales,NULL,NULL),
(31301, N'Revaluation surplus', N'313-01', @RevaluationSurplus, @AC313, @ETB,@106C_Soreti,NULL,NULL),
(31308, N'Reserve of gains and losses on financial assets measured at fair value through other comprehensive income', N'313-08', @ReserveOfGainsAndLossesOnFinancialAssetsMeasuredAtFairValueThroughOtherComprehensiveIncome, @AC313, @ETB,@106C_Soreti,NULL,NULL),
(31315, N'Reserve for non-current assets or disposal groups held for sale', N'313-15', @AmountRecognisedInOtherComprehensiveIncomeAndAccumulatedInEquityRelatingToNoncurrentAssetsOrDisposalGroupsHeldForSale, @AC313, @ETB,@106C_Soreti,NULL,NULL),
(31318, N'Reserve for catastrophe', N'313-18', @ReserveForCatastrophe, @AC313, @ETB,@106C_Soreti,NULL,NULL),
(31324, N'Statutory reserve', N'313-24', @StatutoryReserve, @AC313, @ETB,@106C_Soreti,NULL,NULL),
(41110, N'Revenue from Cleaned Grains', N'411-10', @RevenueFromSaleOfGoods, @AC411, @USD,@106C_ExportCostofSales,@FinishedGrainRD,NULL),
(41120, N'Revenue from Reject Grains', N'411-20', @RevenueFromSaleOfGoods, @AC411, @USD,@106C_ExportCostofSales,@FinishedGrainRD,NULL),
(41210, N'Revenue from Imported Medicine', N'412-10', @RevenueFromSaleOfGoods, @AC412, @ETB,@106C_ImportCostofsales,@TradeMedicineRD,NULL),
(41220, N'Revenue from Construction Materials', N'412-20', @RevenueFromSaleOfGoods, @AC412, @ETB,@106C_ImportCostofsales,@TradeConstructionMaterialRD,NULL),
(41230, N'Revenue from Spare Parts', N'412-30', @RevenueFromSaleOfGoods, @AC412, @ETB,@106C_ImportCostofsales,@TradeSparePartRD,NULL),
(41310, N'Revenue from Processed Oil', N'413-10', @RevenueFromSaleOfGoods, @AC413, @ETB,@106C_AgroProcessingCostofSales,@FinishedOilRD,NULL),
(41320, N'Revenue from Oil Cake', N'413-20', @RevenueFromSaleOfGoods, @AC413, @ETB,@106C_AgroProcessingCostofSales,@FinishedOilRD,NULL),
(41410, N'Revenue from Assembled Minidor', N'414-10', @RevenueFromSaleOfGoods, @AC414, @ETB,@106C_ManufacturingCostofsales,@FinishedVehicleRD,NULL),
(41510, N'Revenue from Local Grains', N'415-10', @RevenueFromSaleOfGoods, @AC415, @ETB,@106C_LocalTradeCostofSales,@FinishedGrainRD,NULL),
(42110, N'Revenue from Soreti Mall', N'421-10', @RevenueFromRenderingOfServices, @AC421, @ETB,@106C_SoretiMallCostofsales,NULL,NULL),
(42120, N'Revenue from A.A. Building', N'421-20', @RevenueFromRenderingOfServices, @AC421, @ETB,@106C_AABuildingCostofsales,NULL,NULL),
(43101, N'Interest Income - Source 1', N'431-01', @RevenueFromInterest, @AC431, @ETB,@106C_Soreti,NULL,NULL),
(43102, N'Dividend Income - Source 1', N'431-02', @RevenueFromDividends, @AC432, @ETB,@106C_Soreti,NULL,NULL),
(43103, N'Other revenue - Source 1', N'431-03', @OtherRevenue, @AC433, @ETB,@106C_Soreti,NULL,NULL),
(43401, N'Income from Reject Grains', N'434-01', @OtherIncome, @AC434, @ETB,NULL,@ByproductGrainRD,NULL),
(43402, N'Income from Oil Cake', N'434-02', @OtherIncome, @AC434, @ETB,@106C_AgroProcessingCostofSales,@ByproductOilRD,NULL),
(51101, N'Raw Materials - Grain Cleaning #1', N'511-01', @RawMaterialsAndConsumablesUsed, @AC511, @ETB,@106C_Site1GrainCleaning,@RawGrainRD,NULL),
(51102, N'Raw Materials - Grain Cleaning #2', N'511-02', @RawMaterialsAndConsumablesUsed, @AC511, @ETB,@106C_Site2GrainCleaning,@RawGrainRD,NULL),
(51103, N'PP Bags and threads - Grain Cleaning #1', N'511-03', @RawMaterialsAndConsumablesUsed, @AC511, @ETB,@106C_Site1GrainCleaning,NULL,NULL),
(51104, N'PP Bags and threads - Grain Cleaning #2', N'511-04', @RawMaterialsAndConsumablesUsed, @AC511, @ETB,@106C_Site2GrainCleaning,NULL,NULL),
(51105, N'Fumigation - Grain Cleaning #1', N'511-05', @RawMaterialsAndConsumablesUsed, @AC511, @ETB,@106C_Site1GrainCleaning,NULL,NULL),
(51106, N'Fumigation - Grain Cleaning #2', N'511-06', @RawMaterialsAndConsumablesUsed, @AC511, @ETB,@106C_Site2GrainCleaning,NULL,NULL),
(51107, N'Plastic Bottle - Oil Milling', N'511-07', @RawMaterialsAndConsumablesUsed, @AC511, @ETB,@106C_Site1OilMilling,NULL,NULL),
(51108, N'Other Packing Material - Oil Milling', N'511-08', @RawMaterialsAndConsumablesUsed, @AC511, @ETB,@106C_Site1OilMilling,NULL,NULL),
(51197, N'O/H Materials absorption - Grain Cleaning #1', N'511-97', @RawMaterialsAndConsumablesUsed, @AC511, @ETB,@106C_Site1GrainCleaning,NULL,NULL),
(51198, N'O/H Materials absorption - Grain Cleaning #2', N'511-98', @RawMaterialsAndConsumablesUsed, @AC511, @ETB,@106C_Site2GrainCleaning,NULL,NULL),
(51199, N'O/H Materials absorption - Oil Milling', N'511-99', @RawMaterialsAndConsumablesUsed, @AC511, @ETB,@106C_Site1OilMilling,NULL,NULL),
(51210, N'Cost of Merchandise Sold - Exported Grains', N'512-10', @CostOfMerchandiseSold, @AC512, @ETB,@106C_ExportCostofSales,@FinishedGrainRD,NULL),
(51221, N'Cost of Merchandise Sold - Medicine', N'512-21', @CostOfMerchandiseSold, @AC512, @USD,@106C_ImportCostofsales,@TradeMedicineRD,NULL),
(51222, N'Cost of Merchandise Sold - Construction Materials', N'512-22', @CostOfMerchandiseSold, @AC512, @USD,@106C_ImportCostofsales,@TradeConstructionMaterialRD,NULL),
(51223, N'Cost of Merchandise Sold - Spare Parts', N'512-23', @CostOfMerchandiseSold, @AC512, @USD,@106C_ImportCostofsales,@TradeSparePartRD,NULL),
(51230, N'Cost of Merchandise Sold - Processed Oil', N'512-30', @CostOfMerchandiseSold, @AC512, @ETB,@106C_AgroProcessingCostofSales,@FinishedOilRD,NULL),
(51240, N'Cost of Merchandise Sold - Assembled Minidor', N'512-40', @CostOfMerchandiseSold, @AC512, @USD,@106C_ManufacturingCostofsales,@FinishedVehicleRD,NULL),
(51250, N'Cost of Merchandise Sold - Local Grains', N'512-50', @CostOfMerchandiseSold, @AC512, @ETB,@106C_LocalTradeCostofSales,@FinishedGrainRD,NULL),
(51311, N'Insurance Expense', N'513-11', @InsuranceExpense, @AC513, NULL,NULL,NULL,NULL),
(51312, N'(More insurance related expenses)', N'513-12', @InsuranceExpense, @AC513, NULL,NULL,NULL,NULL),
(51321, N'Inspection and Standard', N'513-21', @ProfessionalFeesExpense, @AC513, NULL,NULL,NULL,NULL),
(51322, N'Laboratory Service Fee', N'513-22', @ProfessionalFeesExpense, @AC513, NULL,NULL,NULL,NULL),
(51323, N'Maintenance', N'513-23', @ProfessionalFeesExpense, @AC513, NULL,NULL,NULL,NULL),
(51324, N'(More professional related expenses)', N'513-24', @ProfessionalFeesExpense, @AC513, NULL,NULL,NULL,NULL),
(51331, N'Truck Rental', N'513-31', @TransportationExpense, @AC513, @ETB,NULL,NULL,NULL),
(51332, N'(more transportation related expenses)', N'513-32', @TransportationExpense, @AC513, @ETB,NULL,NULL,NULL),
(51341, N'Bank fees', N'513-41', @BankAndSimilarCharges, @AC513, NULL,NULL,NULL,NULL),
(51342, N'(More Bank and similar charges)', N'513-42', @BankAndSimilarCharges, @AC513, NULL,NULL,NULL,NULL),
(51351, N'Travel expense', N'513-51', @TravelExpense, @AC513, NULL,NULL,NULL,NULL),
(51352, N'(More travel related expenses)', N'513-52', @TravelExpense, @AC513, NULL,NULL,NULL,NULL),
(51361, N'Internet Subscription', N'513-61', @CommunicationExpense, @AC513, NULL,NULL,NULL,NULL),
(51362, N'(More Communication related expenses)', N'513-62', @CommunicationExpense, @AC513, NULL,NULL,NULL,NULL),
(51371, N'Electricity and Power', N'513-71', @UtilitiesExpense, @AC513, @ETB,NULL,NULL,NULL),
(51372, N'(More utilities expenses)', N'513-72', @UtilitiesExpense, @AC513, @ETB,NULL,NULL,NULL),
(51381, N'Advertisement', N'513-81', @AdvertisingExpense, @AC513, @ETB,NULL,NULL,NULL),
(51382, N'Promotional Cost', N'513-82', @AdvertisingExpense, @AC513, @ETB,NULL,NULL,NULL),
(51383, N'(More advertising expenses)', N'513-83', @AdvertisingExpense, @AC513, @ETB,NULL,NULL,NULL),
(51411, N'Wages and Salaries', N'514-11', @WagesAndSalaries, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51412, N'Overtime', N'514-12', @WagesAndSalaries, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51413, N'Transportation Allowances', N'514-13', @WagesAndSalaries, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51414, N'Labour, Loading & Unloading', N'514-14', @WagesAndSalaries, @AC514, NULL,NULL,@EmployeeBenefitRD,NULL),
(51415, N'(More Wages and Salaries related expenses)', N'514-15', @WagesAndSalaries, @AC514, NULL,NULL,@EmployeeBenefitRD,NULL),
(51421, N'Provident Fund', N'514-21', @SocialSecurityContributions, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51422, N'Pension fund', N'514-22', @SocialSecurityContributions, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51423, N'(More social security contribution related expenses)', N'514-23', @SocialSecurityContributions, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51431, N'Medical Expenses', N'514-31', @OtherShorttermEmployeeBenefits, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51432, N'Bonus', N'514-32', @OtherShorttermEmployeeBenefits, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51433, N'Uniform & Outfits', N'514-33', @OtherShorttermEmployeeBenefits, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51434, N'Perdiem and travel costs - Local', N'514-34', @OtherShorttermEmployeeBenefits, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51435, N'Perdiem and travel costs - Foreign', N'514-35', @OtherShorttermEmployeeBenefits, @AC514, @USD,NULL,@EmployeeBenefitRD,NULL),
(51436, N'Training and development', N'514-36', @OtherShorttermEmployeeBenefits, @AC514, NULL,NULL,@EmployeeBenefitRD,NULL),
(51437, N'Compensation & Leave pay', N'514-37', @OtherShorttermEmployeeBenefits, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51438, N'Cash Indemnity', N'514-38', @OtherShorttermEmployeeBenefits, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51439, N'Employees Insurance', N'514-39', @OtherShorttermEmployeeBenefits, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51440, N'(More short term employee benefits related expenses)', N'514-40', @OtherShorttermEmployeeBenefits, @AC514, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51510, N'Depreciation', N'515-10', @DepreciationExpense, @AC515, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51520, N'Amortization', N'515-20', @AmortisationExpense, @AC515, @ETB,NULL,@EmployeeBenefitRD,NULL),
(51901, N'Land and Building Taxes', N'519-01', @OtherExpenseByNature, @AC519, NULL,NULL,NULL,NULL),
(51902, N'Misc. Expenses by nature', N'519-02', @OtherExpenseByNature, @AC519, NULL,NULL,NULL,NULL),
(52110, N'Gain (loss) on disposal of property, plant and equipment', N'521-10', @GainLossOnDisposalOfPropertyPlantAndEquipmentExtension, @AC521, NULL,NULL,NULL,NULL),
(52120, N'Gain (loss) on foreign exchange', N'521-20', @GainLossOnForeignExchangeExtension, @AC521, NULL,NULL,NULL,NULL),
(52201, N'Gains (losses) on net monetary position', N'522-01', @GainsLossesOnNetMonetaryPosition, @AC522, NULL,@106C_Soreti,NULL,NULL),
(52202, N'Gain (loss) arising from derecognition of financial assets measured at amortised cost', N'522-02', @GainLossArisingFromDerecognitionOfFinancialAssetsMeasuredAtAmortisedCost, @AC522, NULL,@106C_Soreti,NULL,NULL),
(52203, N'Finance income', N'522-03', @FinanceIncome, @AC522, NULL,@106C_Soreti,NULL,NULL),
(52204, N'Finance costs', N'522-04', @FinanceCosts, @AC522, NULL,@106C_Soreti,NULL,NULL),
(52205, N'Impairment gain and reversal of impairment loss (impairment loss) determined in accordance with IFRS 9', N'522-05', @ImpairmentLossImpairmentGainAndReversalOfImpairmentLossDeterminedInAccordanceWithIFRS9, @AC522, NULL,@106C_Soreti,NULL,NULL),
(52206, N'Share of profit (loss) of associates and joint ventures accounted for using equity method', N'522-06', @ShareOfProfitLossOfAssociatesAndJointVenturesAccountedForUsingEquityMethod, @AC522, NULL,@106C_Soreti,NULL,NULL),
(52207, N'Other income (expense) from subsidiaries, jointly controlled entities and associates', N'522-07', @OtherIncomeExpenseFromSubsidiariesJointlyControlledEntitiesAndAssociates, @AC522, NULL,@106C_Soreti,NULL,NULL),
(52208, N'Gains (losses) arising from difference between previous amortised cost and fair value of financial assets reclassified out of amortised cost into fair value through profit or loss measurement category', N'522-08', @GainsLossesArisingFromDifferenceBetweenPreviousCarryingAmountAndFairValueOfFinancialAssetsReclassifiedAsMeasuredAtFairValue, @AC522, NULL,@106C_Soreti,NULL,NULL),
(52209, N'Cumulative gain (loss) previously recognised in other comprehensive income arising from reclassification of financial assets out of fair value through other comprehensive income into fair value through profit or loss measurement category', N'522-09', @CumulativeGainLossPreviouslyRecognisedInOtherComprehensiveIncomeArisingFromReclassificationOfFinancialAssetsOutOfFairValueThrou, @AC522, NULL,@106C_Soreti,NULL,NULL),
(52210, N'Hedging gains (losses) for hedge of group of items with offsetting risk positions', N'522-10', @HedgingGainsLossesForHedgeOfGroupOfItemsWithOffsettingRiskPositions, @AC522, NULL,@106C_Soreti,NULL,NULL),
(52211, N'Tax income (expense)', N'522-11', @IncomeTaxExpenseContinuingOperations, @AC522, NULL,@106C_Soreti,NULL,NULL),
(71101, N'Cash control', N'711-01', @CashControlExtension, @AC711, @ETB,@106C_Soreti,NULL,NULL),
(71112, N'Trading control', N'711-12', @TradingControlExtension, @AC711, @ETB,@106C_Soreti,NULL,NULL),
(71123, N'Payroll control', N'711-23', @PayrollControlExtension, @AC711, @ETB,@106C_Soreti,NULL,NULL),
(71134, N'Other document control', N'711-34', @OtherControlExtension, @AC711, @ETB,@106C_Soreti,NULL,NULL)
