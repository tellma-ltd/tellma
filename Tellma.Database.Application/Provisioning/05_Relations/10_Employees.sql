	DECLARE @employees dbo.[RelationList], @AgentRates dbo.AgentRateList;
...
BEGIN
	...
	SELECT 
		...
		@MohamadAkra = (SELECT [Id] FROM [dbo].[fi_Relations](N'employees', NULL) WHERE [Name] = N'Mohamad Akra'), 
		@AhmadAkra = (SELECT [Id] FROM [dbo].[fi_Relations](N'employees', NULL) WHERE [Name] = N'Ahmad Akra'), 
