...
(10001,1000, N'Consolidated Board of Directors', N'مجلس الإدارة الموحد', N'10001', N'Administration'),
(10002,1000, N'Board of Commissioners', N'مجلس المفوضين ', N'10002', N'Administration'),
...
(12100,121, N'Directorate General for Financial Affairs', N'الإدارة العامة للشئون المالية ', N'12100', N'Administration'),
(1211,121, N'Finance', N'المالية ', N'1211', N'Abstract'),
(12110,1211, N'Finance Department', N'الإدارة المالية ', N'12110', N'Administration'),
(12111,1211, N'Accounts Division', N'قسم الحسابات', N'12111', N'Administration'),
(12112,1211, N'Final Accounts Division', N'قسم الحسابات الختامية', N'12112', N'Administration'),
(12113,1211, N'Collection Division', N'قسم التحصيل', N'12113', N'Administration'),
(12114,1211, N'Payments Division', N'قسم الدفعيات', N'12114', N'Administration'),
(12115,1211, N'Procurement Division', N'قسم المشتريات', N'12115', N'Administration'),
(122,12, N'Human Resources and Administrative Affairs', N'تنمية الموارد البشرية والشئون الادارية ', N'122', N'Abstract'),
(12200,122, N'Directorate General for Human Resources and Administrative Affairs', N'الإدارة العامة لتنمية الموارد البشرية والشئون الادارية ', N'12200', N'Administration'),
(1221,122, N'Human Resource Development', N'تنمية الموارد البشرية ', N'1221', N'Abstract'),
(12210,1221, N'Human Resources Development Department', N'إدارة تنمية الموارد البشرية', N'12210', N'Administration'),
(12211,1221, N'Personnel Division', N'قسم شئون العاملين', N'12211', N'Administration'),
(12212,1221, N'Training Division', N'قسم التدريب', N'12212', N'Administration'),
(1222,122, N'Administrative Affairs', N'الشئون الادارية ', N'1222', N'Abstract'),
(12220,1222, N'Administrative Affairs Department', N'إدارة الشئون الادارية', N'12220', N'Administration'),
(12221,1222, N'Services Division', N'قسم الخدمات', N'12221', N'Administration'),
(12222,1222, N'Security and Safety Division', N'قسم الأمن والسلامة', N'12222', N'Administration'),
(123,12, N'Corporate and Real Estate Development', N'الشركات والتنمية العقارية ', N'123', N'Abstract'),
(12300,123, N'Public administration companies and Real Estate Development', N'الإدارة العامة للشركات والتنمية العقارية', N'12300', N'Administration'),
(1231,123, N'Agricultural Investment', N'الاستثمار الزراعي', N'1231', N'Abstract'),
(12310,1231, N'Department of Agricultural Investment', N'إدارة الاستثمار الزراعي', N'12310', N'Administration'),
(1232,123, N'Tourism Investment and Hotels', N'الاستثمار السياحي والفنادق', N'1232', N'Abstract'),
(12320,1232, N'Department of Tourism Investment and Hotels', N'إدارة الاستثمار السياحي والفنادق', N'12320', N'Administration'),
(1233,123, N'Industrial Investment', N'الاستثمار الصناعي', N'1233', N'Abstract'),
(12330,1233, N'Department of Industrial Investment', N'إدارة الاستثمار الصناعي', N'12330', N'Administration'),
(1234,123, N'Medical Investment', N'الاستثمار الطبي', N'1234', N'Abstract'),
(12340,1234, N'Department of Medical Investment', N'إدارة الاستثمار الطبي', N'12340', N'Administration'),
(1235,123, N'Marketing', N'التسويق', N'1235', N'Abstract'),
(12350,1235, N'Marketing Department', N'إدارة التسويق', N'12350', N'Administration'),
(12351,1235, N'Commercial Marketing', N'التسويق التجاري', N'12351', N'Administration'),
(12352,1235, N'Real Estate Marketing', N'التسويق العقاري', N'12352', N'Administration'),
(1236,123, N'Real Estate Development', N'التنمية العقارية', N'1236', N'Abstract'),
(12360,1236, N'Real Estate Development Department', N'إدارة التنمية العقارية', N'12360', N'Administration'),
(12361,1236, N'Development Division', N'قسم التطوير العقاري', N'12361', N'Administration'),
(12362,1236, N'Projects Division', N'قسم المشروعات', N'12362', N'Administration'),
(124,12, N'Studies and Strategic Planning', N'الدراسات والتخطيط الاستراتيجي ', N'124', N'Abstract'),
(12400,124, N'Directorate General for Studies and Strategic Planning', N'الإدارة العامة للدراسات والتخطيط الاستراتيجي', N'12400', N'Administration'),
(1241,124, N'Studies and Research', N'الدراسات والبحوث', N'1241', N'Abstract'),
(12410,1241, N'Studies and Research Department', N'إدارة الدراسات والبحوث', N'12410', N'Administration'),
(12411,1241, N'Risk Department', N'قسم المخاطر', N'12411', N'Administration'),
(12412,1241, N'Total Quality Department', N'قسم الجودة الشاملة', N'12412', N'Administration'),
(12413,1241, N'Department of Feasibility Studies and Statistics', N'قسم دراسات الجدوى والاحصاء', N'12413', N'Administration'),
(12414,1241, N'Research and Development Department', N'قسم البحوث والتطوير', N'12414', N'Administration'),
(1242,124, N'Information Technology', N'تكنولوجيا المعلومات ', N'1242', N'Abstract'),
(12420,1242, N'Information Technology Management', N'إدارة تكنولوجيا المعلومات', N'12420', N'Administration'),
(12421,1242, N'Technical Support and Maintenance Department', N'قسم الدعم الفني والصيانة', N'12421', N'Administration'),
(12422,1242, N'Department of Network and Information Security', N'قسم الشبكات وامن المعلومات', N'12422', N'Administration'),
(12423,1242, N'Systems Development and Software Division', N'قسم تطوير الانظمة والبرمجيات', N'12423', N'Administration'),
(125,12, N'Financial investment and smart partnerships', N'الاستثمار المالي والشراكات الذكية ', N'125', N'Abstract'),
(12500,125, N'Directorate General for Financial Investment and smart partnerships', N'الإدارة العامة للاستثمار المالي والشراكات الذكية ', N'12500', N'Administration'),
(1251,125, N'Banking System', N'الجهاز المصرفي', N'1251', N'Abstract'),
(12510,1251, N'Banking System Department', N'إدارة الجهاز المصرفي', N'12510', N'Administration'),
(1252,125, N'Financial Services', N'الخدمات المالية', N'1252', N'Abstract'),
(12520,1252, N'Financial Services Department', N'إدارة الخدمات المالية', N'12520', N'Administration'),
(1253,125, N'Internal Trade Finance', N'التمويل التجاري الداخلي', N'1253', N'Abstract'),
(12530,1253, N'Internal Trade Finance Department', N'إدارة التمويل التجاري الداخلي', N'12530', N'Administration'),
(129,12, N'Commissioner-General', N'المفوض العام', N'129', N'Abstract'),
(12900,129, N'Office of the Commissioner-General', N'مكتب المفوض العام', N'12900', N'Administration'),
(1291,129, N'Public relations', N'العلاقات العامة', N'1291', N'Abstract'),
(12910,1291, N'Public Relations Department', N'إدارة العلاقات العامة', N'12910', N'Administration'),
(12911,1291, N'Department of Media', N'قسم الإعلام', N'12911', N'Administration'),
(12912,1291, N'Protocol Department', N'قسم المراسم', N'12912', N'Administration'),
(12913,1291, N'Management Office Executive', N'إدارة المكتب التنفيذي', N'12913', N'Administration'),
(12914,1291, N'Internal Audit Management', N'إدارة المراجعة الداخلية', N'12914', N'Administration'),
(12915,1291, N'Legal Counsel', N'المستشار القانوني', N'12915', N'Administration'),
...
(21000,21, N'Saffat Towers- Sale', N'أبراج الصافات- مبيعات', N'21000', N'Sale'),
(211,21, N'Saffat Towers - SGA', N'أبراج الصافات - مصروفات غير مباشرة', N'211', N'Abstract'),
(21100,211, N'Saffat Towers - SGA', N'أبراج الصافات - مصروفات غير مباشرة', N'21100', N'Administration'),
(22,2, N'Pearl Complex', N'مجمع لؤلؤة الثغر', N'22', N'BusinessUnit'),
(22000,22, N'Pearl Complex- Sale', N'لؤلؤة الثغر- مبيعات', N'22000', N'Sale'),
(221,22, N'Pearl Complex - SGA', N'لؤلؤة الثغر - مصروفات غير مباشرة', N'221', N'Abstract'),
(22100,221, N'Pearl Complex - SGA', N'لؤلؤة الثغر - مصروفات غير مباشرة', N'22100', N'Administration'),
(23,2, N'Rayyan Scheme', N'مخطط الريان', N'23', N'BusinessUnit'),
(23000,23, N'Rayyan Scheme - Cost of Sales', N'مخطط الريان- مبيعات', N'23000', N'Sale'),
(231,23, N'Rayyan Scheme - SGA', N'مخطط الريان - مصروفات إدارية وتسويقية', N'231', N'Abstract'),
(23100,231, N'Rayyan Scheme - SGA', N'مخطط الريان - مصروفات إدارية وتسويقية', N'23100', N'Administration'),
(24,2, N'Yasmine Scheme', N'مخطط الياسمين', N'24', N'BusinessUnit'),
(24000,24, N'Yasmine Scheme - Cost of Sales', N'مخطط الياسمين- مبيعات', N'24000', N'Sale'),
(241,24, N'Yasmine Scheme - SGA', N'مخطط الياسمين - مصروفات إدارية وتسويقية', N'241', N'Abstract'),
(24100,241, N'Yasmine Scheme - SGA', N'مخطط الياسمين - مصروفات إدارية وتسويقية', N'24100', N'Administration'),
(25,2, N'Mehira Scheme', N'مخطط مهيرة', N'25', N'BusinessUnit'),
(25000,25, N'Mehira Scheme - Cost of Sales', N'مخطط مهيرة- مبيعات', N'25000', N'Sale'),
(251,25, N'Mehira Scheme - SGA', N'مخطط مهيرة - مصروفات إدارية وتسويقية', N'251', N'Abstract'),
(25100,251, N'Mehira Scheme - SGA', N'مخطط مهيرة - مصروفات إدارية وتسويقية', N'25100', N'Administration'),
...
(25201,252, N'Mehira Scheme - Phase 1', N'مخطط مهيرة - المرحلة الأولى', N'25201', N'ConstructionInProgressExpendituresControl'),
(25202,252, N'Mehira Scheme - Phase 2', N'مخطط مهيرة - المرحلة الثانية', N'25202', N'ConstructionInProgressExpendituresControl');
...
DECLARE @107C_SaffatTowersDirectExpenses INT = (SELECT [Id] FROM dbo.[Centers] WHERE [CenterType] <> N'Abstract' AND [Name] = N'Saffat Towers- Sale');
...
DECLARE @107C_PearlComplexDirectExpenses INT = (SELECT [Id] FROM dbo.[Centers] WHERE [CenterType] <> N'Abstract' AND [Name] = N'Pearl Complex- Sale');
...
DECLARE @107C_RayyanSchemeSale INT = (SELECT [Id] FROM dbo.[Centers] WHERE [CenterType] <> N'Abstract' AND [Name] = N'Rayyan Scheme - Cost of Sales');
...
DECLARE @107C_YasmineSchemeSale INT = (SELECT [Id] FROM dbo.[Centers] WHERE [CenterType] <> N'Abstract' AND [Name] = N'Yasmine Scheme - Cost of Sales');
...
DECLARE @107C_MehiraSchemeSale INT = (SELECT [Id] FROM dbo.[Centers] WHERE [CenterType] <> N'Abstract' AND [Name] = N'Mehira Scheme - Cost of Sales');
