...
BEGIN
	...
	(0,N'SteelRoll',N'Steel Rolls',	N'Steel Roll',		N'Roll #',			N'Optional',			@mt);
	...
	INSERT INTO @Resources ([Index],
		[Name],				[Code],			[Identifier], [UnitMass], [UnitMassUnitId],[CurrencyId],[Lookup1Id]) VALUES
	(0, N'HR 1000MMx1.9MM',	N'HR1000x1.9',	N'1001',		23.332,		@Kg,			@ETB,		dbo.fn_Lookup(N'SteelThickness', N'1.9')),
	(1, N'CR 1000MMx1.4MM',	N'CR1000x1.4',	N'1002',		11.214,		@Kg,			@ETB,		dbo.fn_Lookup(N'SteelThickness', N'1.4'));
