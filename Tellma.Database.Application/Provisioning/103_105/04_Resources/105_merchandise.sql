...
BEGIN
	...
	--N'Merchandise'
		[Name2],							[Name],								[Code],
		[Lookup1Id],										[Lookup2Id],												
		[Lookup3Id],										[Decimal1],			[Decimal2],		[CurrencyId],
		[Text1],											[Text2],			[Int1],			[Int2]) VALUES
	(0, N'رول جريدة أبيض فنلندي ستورا',	N'Newspaper Roll White Finnish Estora',	N'2504-66011',
		[dbo].[fn_Lookup](N'paper-origins', N'Finnish'),	[dbo].[fn_Lookup](N'paper-groups', N'Newspaper Roll paper'),
		[dbo].[fn_Lookup](N'paper-types', N'Newspaper'),	66,					0,				@SAR,
		N'White - أبيض',									N'50-66',			49,				8),

	(1,	N'مكربن أولى أبيض - فونكس',		N'Carbonless Coated Paper White Phoenix',N'0200-01231',
		[dbo].[fn_Lookup](N'paper-origins', N'Thai'),		[dbo].[fn_Lookup](N'paper-groups', N'Carbonless Coated paper'),
		[dbo].[fn_Lookup](N'paper-types', N'Commercial'),	70,					100,			@SAR,	
		N'White - أبيض',									N'70-100',			56,				1),
	(2, N'كربون لامع 70-100\130غ',			N'2/S Coated Paper Glazed - 70x100/130 g',	N'3300-01201',
		[dbo].[fn_Lookup](N'paper-origins', N'Finnish'),	[dbo].[fn_Lookup](N'paper-groups', N'Coated Paper Glazed'),
		[dbo].[fn_Lookup](N'paper-types', N'Commercial'),	70,					100,			@SAR,
		N'White - أبيض',									N'70-100',			130,			6),
	(3,	N'كربون لامع 60-90\170غ',			N'2/S Coated Paper Glazed - 60x90/170 g',	N'3300-01202',
		[dbo].[fn_Lookup](N'paper-origins', N'German'),		[dbo].[fn_Lookup](N'paper-groups', N'Coated Paper Glazed'),
		[dbo].[fn_Lookup](N'paper-types', N'Commercial'),	60,					90,				@SAR,
		N'White - أبيض',									N'60-90',			170,			4),

	(4, N'كربون لامع 62-92\200غ',			N'2/S Coated Paper Glazed - 62x92/200 g',	N'3300-01203',
		[dbo].[fn_Lookup](N'paper-origins', N'German'),	[dbo].[fn_Lookup](N'paper-groups', N'Coated Paper Glazed'),
		[dbo].[fn_Lookup](N'paper-types', N'Commercial'),	62,					92,				@SAR,
		N'White - أبيض',									N'62-92',			200,			7),

	(5,	N'كربون لامع 62-92\300غ',			N'2/S Coated Paper Glazed - 62x92/300 g',	N'3300-01204',
		[dbo].[fn_Lookup](N'paper-origins', N'German'),		[dbo].[fn_Lookup](N'paper-groups', N'Coated Paper Glazed'),
		[dbo].[fn_Lookup](N'paper-types', N'Commercial'),	62,					92,				@SAR,
		N'White - أبيض',									N'62-92',			300,			7),
	(6, N'كربون لامع 70-100\250غ',			N'2/S Coated Paper Glazed - 70x100/250 g',	N'3300-01205',
		[dbo].[fn_Lookup](N'paper-origins', N'German'),	[dbo].[fn_Lookup](N'paper-groups', N'Coated Paper Glazed'),
		[dbo].[fn_Lookup](N'paper-types', N'Commercial'),	70,					100,			@SAR,
