...
--	(18,N'11208',@employeeADef,					@Debtors_AC,			@CurrentTradeReceivables,NULL,					N'Employees Expenditures',		NULL,			@C101_INV,		NULL,				NULL),
	...
	(21,N'11211',@OtherCurrentFinancialAssets,	@Debtors_AC,			@DebtorCD,				NULL,					N'Banan ET',					@USD,			@C101_INV,		NULL,				NULL),
	(22,N'11212',@OtherCurrentFinancialAssets,	@Debtors_AC,			@DebtorCD,				NULL,					N'PrimeLedgers A/R',			@USD,			@C101_INV,		NULL,				NULL),

	(23,N'11221',@OtherCurrentFinancialAssets,	@Debtors_AC,			@PartnerCD,			NULL,					N'Partners Withdrawals',		@USD,			@C101_INV,		NULL,				NULL),

	(24,N'12021',@OtherCurrentFinancialAssets,	@Debtors_AC,			@EmployeeCD,			NULL,					N'Abu Ammar Car Loan',			@USD,			@C101_INV,		NULL,				@Abu_Ammar),
	(25,N'12022',@OtherCurrentFinancialAssets,	@Debtors_AC,			@EmployeeCD,			NULL,					N'M. Ali Car Loan',				@USD,			@C101_INV,		NULL,				@M_Ali),
	(26,N'12023',@OtherCurrentFinancialAssets,	@Debtors_AC,			@EmployeeCD,			NULL,					N'El-Amin Car Loan',			@USD,			@C101_INV,		NULL,				@el_Amin),
...
--	(28,N'11206',@TradeAndOtherCurrentReceivables,@Debtors_AC,		@TradeAndOtherCurrentReceivables,	N'Commissions',					@USD,			@C101_INV,		NULL,				NULL),
	(29,N'11231',@CurrentPrepayments,			@Debtors_AC,			@SupplierCD,			NULL,					N'Office Rent',					@SDG,			@C101_INV,		NULL,				NULL),
	(30,N'11232',@CurrentPrepayments,			@Debtors_AC,			@SupplierCD,			NULL,					N'Internet Prepayment',			@SDG,			@C101_INV,		NULL,				NULL),
	(31,N'11233',@CurrentPrepayments,			@Debtors_AC,			@SupplierCD,			NULL,					N'Car Rent Prepayment',			@SDG,			@C101_INV,		NULL,				NULL),
	(32,N'11234',@CurrentPrepayments,			@Debtors_AC,			@SupplierCD,			NULL,					N'House Rent Prepayment',		@SDG,			@C101_INV,		NULL,				NULL),
	(33,N'11235',@CurrentPrepayments,			@Debtors_AC,			@SupplierCD,			NULL,					N'Maintenance Prepayment',		@SDG,			@C101_INV,		NULL,				NULL),

	(38,N'11241',@DeferredIncomeClassifiedAsCurrent,@Debtors_AC,		@CustomerCD,			NULL,					N'Accrued Income',				NULL,			@C101_INV,		NULL,				NULL),
	...
	(56,N'30091',@CashControlExtension,			@Equity_AC,				@SupplierCD,			NULL,					N'Payments to Suppliers Control',	NULL,		@C101_INV,		NULL,				NULL),
	(57,N'30092',@CashControlExtension,			@Equity_AC,				@CustomerCD,			NULL,					N'Payents from Customers Control',	NULL,		@C101_INV,		NULL,				NULL),
	(58,N'30093',@TradingControlExtension,		@Equity_AC,				@SupplierCD,			NULL,					N'Receipts from Suppliers Control',	NULL,		@C101_INV,		NULL,				NULL),
	(59,N'30094',@TradingControlExtension,		@Equity_AC,				@CustomerCD,			NULL,					N'Deliveries to Customers Control',	NULL,		@C101_INV,		NULL,				NULL),


--	(61,N'21101',@employeeADef,	@CurrentLiabilities_AC,@TradeAndOtherCurrentPayables,	N'Employees Payables',			NULL,			@C101_INV,		NULL,				NULL),
	(63,N'21103',@OtherCurrentFinancialLiabilities,@CurrentLiabilities_AC,@EmployeeCD,			NULL,					N'10% Retained Salaries',		@USD,			@C101_INV,		NULL,				NULL),
	(64,N'21201',@OtherCurrentFinancialLiabilities,@CurrentLiabilities_AC,@DebtorCD,			NULL,					N'PrimeLedgers A/P',			@USD,			@C101_INV,		NULL,				NULL),

	(65,N'21202',@TradeAndOtherCurrentPayablesToTradeSuppliers,@CurrentLiabilities_AC,@SupplierCD,NULL,				N'Trade Payables',				NULL,			@C101_INV,		NULL,				NULL),
	(66,N'21203',@AccrualsClassifiedAsCurrent,@CurrentLiabilities_AC,	@SupplierCD,			NULL,					N'Accrued Expenses',			NULL,			@C101_INV,		NULL,				NULL),
	(67,N'21299',@DeferredIncomeClassifiedAsCurrent,@CurrentLiabilities_AC,@CustomerCD,		NULL,					N'Unearned Revenues',			NULL,			@C101_INV,		NULL,				NULL),

	(68,N'21301',@OtherCurrentPayables,@CurrentLiabilities_AC,			@PartnerCD,			NULL,					N'Dividends Payables',			@USD,			@C101_INV,		NULL,				NULL),
	(70,N'21302',@OtherCurrentFinancialLiabilities,@CurrentLiabilities_AC,@PartnerCD,			NULL,					N'Borrowings from M/A',			@USD,			@C101_INV,		NULL,				@PartnerMA),
