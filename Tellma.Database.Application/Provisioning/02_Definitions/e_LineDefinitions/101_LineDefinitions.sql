...
SET [Script] = N'
	...
	SET
		...
		[NotedAgentName1] = (SELECT [Name] FROM dbo.Relations WHERE [Id] = [NotedelationId0]),
...
(3,1,	N'NotedRelationId',		0,	N'Supplier',			N'المورد',				3,4,1),
...
(8,1,	N'RelationId',			1,	N'Bank/Cashier',		N'البنك\الخزنة',		3,4,0),
...
SET [Script] = N'
	...
	SET
		...
		[RelationId0]	= [NotedelationId1],
		[NotedAgentName2] = (SELECT [Name] FROM dbo.Relations WHERE [Id] = [NotedRelationId1]),
	...
	--UPDATE PWL -- Show the due balance for each relation
	--	SET PWL.[NotedAmount0] = T.Balance
	--FROM @ProcessedWideLines PWL
	--JOIN (
	--	SELECT E.RelationId, E.CurrencyId, SUM(E.[Direction] * E.[MonetaryValue]) AS [Balance]
	--	FROM dbo.Entries E
	...
	--) T ON T.RelationId = PWL.RelationIdd2 AND T.CurrencyId = PWL.CurrencyId2
	-----
	--SELECT * FROM @ProcessedWideLines;'
WHERE [Index] = 2;
INSERT INTO @LineDefinitionEntries([Index], [HeaderIndex],
...
(3,2,	N'NotedRelationId',		1,	N'Supplier',		N'المورد',				3,4,1),
...
(8,2,	N'RelationId',			2,	N'Bank/Cashier',	N'البنك\الخزنة',		3,4,0),
...
(6,3,	N'RelationId',				0,	N'Warehouse',		N'المخزن',			3,3,1),
(7,3,	N'CenterId',			0,	N'Invest. Ctr',		N'مركز الاستثمار',	4,4,1),
(8,3,	N'NotedRelationId',		0,	N'Supplier',		N'المورد',			3,3,1);
...
(4,9,	N'RelationId',			0,	N'Bank/Cashier',		N'البنك/الخزنة',		3,3,0),
...
SET [Script] = N'
	...
	UPDATE @ProcessedWideLines
	SET
		[NotedAgentName0] = (SELECT [Name] FROM dbo.Relations WHERE [Id] = [RelationId1]),
		[NotedAgentName1] = (SELECT [Name] FROM dbo.Relations WHERE [Id] = [RelationId0]),
		[CenterId1] = [CenterId0],
...
INSERT INTO @LineDefinitionColumns([Index], [HeaderIndex],
		[ColumnName],[EntryIndex],	[Label],			[Label2],			[RequiredState],
																			[ReadOnlyState],
																			[InheritsFromHeader]) VALUES
(0,10,	N'RelationId',			1,	N'From Account',	N'من حساب',			1,2,0),
(1,10,	N'RelationId',			0,	N'To Account',		N'إلى حساب',		1,2,0),
...
(8,11,	N'RelationId',			0,	N'Bank/Cashier',		N'البنك\الخزنة',		3,4,0),
...
(1,12,	N'NotedRelationId',		1,	N'Customer',		N'الزبون',				1,4,1),
...
(8,12,	N'RelationId',			0,	N'Bank/Cashier',	N'البنك\الخزنة',		3,4,1),
...
(1,13,	N'NotedRelationId',		1,	N'Customer',		N'الزبون',				1,4,1),
...
(8,13,	N'RelationId',			0,	N'Bank/Cashier',	N'البنك\الخزنة',		3,4,1),
...
(3,19,	N'RelationId',			0,	N'Bank/Cashier',	N'البنك/الخزنة',	3,4,1),
...
INSERT INTO @LineDefinitionColumns([Index], [HeaderIndex],
		[ColumnName],[EntryIndex],	[Label],		[Label2],				[RequiredState],
																			[ReadOnlyState],
																			[InheritsFromHeader]) VALUES
(0,15,	N'NotedRelationId',	0,	N'Customer',		N'الزبون',				1,4,1),
...
INSERT INTO @LineDefinitionColumns([Index], [HeaderIndex],
		[ColumnName],[EntryIndex],	[Label],		[Label2],		[RequiredState],
																				[ReadOnlyState],
																				[InheritsFromHeader]) VALUES
(0,24,	N'RelationId',				1,	N'Lessor',		N'المؤجر',		1,4,0),
...
INSERT INTO @LineDefinitionColumns([Index], [HeaderIndex],
		[ColumnName],[EntryIndex],	[Label],		[Label2],				[RequiredState],
																			[ReadOnlyState],
																			[InheritsFromHeader]) VALUES
(0,32,	N'RelationId',		0,	N'Customer',		N'الزبون',				1,4,1),
...
INSERT INTO @LineDefinitionColumns([Index], [HeaderIndex],
		[ColumnName],[EntryIndex],	[Label],		[Label2],				[RequiredState],
																			[ReadOnlyState],
																			[InheritsFromHeader]) VALUES
(0,33,	N'RelationId',		0,	N'Customer',		N'الزبون',				1,4,1),
...
INSERT INTO @LineDefinitionColumns([Index], [HeaderIndex],
		[ColumnName],[EntryIndex],	[Label],		[Label2],				[RequiredState],
																			[ReadOnlyState],
																			[InheritsFromHeader]) VALUES
(0,34,	N'RelationId',		0,	N'Customer',		N'الزبون',				1,4,0),
...
INSERT INTO @LineDefinitionColumns([Index], [HeaderIndex],
		[ColumnName],[EntryIndex],	[Label],		[Label2],				[RequiredState],
																			[ReadOnlyState],
																			[InheritsFromHeader]) VALUES
(0,35,	N'RelationId',		0,	N'Customer',		N'الزبون',				1,4,0),
