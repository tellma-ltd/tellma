...
RETURN
	...
	WITH (
		...
		[AgentAccountId1]		INT,
		[ResourceId1]			INT,
		[DECIMAL (19,4)Amount1]			DECIMAL (19,4),
		[Mass1]					DECIMAL,
		[Volume1]				DECIMAL,
		[Count1]				DECIMAL,
		[Time1]					DECIMAL,
		...
		[RelatedDECIMAL (19,4)Amount1]	DECIMAL (19,4),
		...
		[AgentAccountId2]		INT,
		[ResourceId2]			INT,
		[DECIMAL (19,4)Amount2]			DECIMAL (19,4),
		[Mass2]					DECIMAL,
		[Volume2]				DECIMAL,
		[Count2]				DECIMAL,
		[Time2]					DECIMAL,
		...
		[RelatedDECIMAL (19,4)Amount2]	DECIMAL (19,4),
		...
		[AgentAccountId3]		INT,
		[ResourceId3]			INT,
		[DECIMAL (19,4)Amount3]			DECIMAL (19,4),
		[Mass3]					DECIMAL,
		[Volume3]				DECIMAL,
		[Count3]				DECIMAL,
		[Time3]					DECIMAL,
		...
		[RelatedDECIMAL (19,4)Amount3]	DECIMAL (19,4),
		...
		[AgentAccountId4]		INT,
		[ResourceId4]			INT,
		[DECIMAL (19,4)Amount4]			DECIMAL (19,4),
		[Mass4]					DECIMAL,
		[Volume4]				DECIMAL,
		[Count4]				DECIMAL,
		[Time4]					DECIMAL,
		...
		[RelatedDECIMAL (19,4)Amount4]	DECIMAL (19,4),
