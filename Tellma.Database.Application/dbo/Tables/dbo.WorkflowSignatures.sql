CREATE TABLE [dbo].[WorkflowSignatures] (
	...
	[RuleTypeEntryNumber]	INT					CONSTRAINT [FK_WorkflowSignatures__RuleTypeEntryNumber] CHECK([RuleTypeEntryNumber] >= 0),
	...
	CONSTRAINT [CK_WorkflowSignatures__RuleType_RuleTypeEntryNumber] CHECK ([RuleType] <> N'ByAgent' OR [RuleTypeEntryNumber] IS NOT NULL),
