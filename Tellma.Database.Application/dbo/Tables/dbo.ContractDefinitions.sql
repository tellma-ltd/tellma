...
(
	...
	[Lookup1DefinitionId]				INT				CONSTRAINT [FK_ContractDefinitions__Lookup1DefinitionId] REFERENCES dbo.LookupDefinitions([Id]),
	...
	[Lookup2DefinitionId]				INT				CONSTRAINT [FK_ContractDefinitions__Lookup2DefinitionId] REFERENCES dbo.LookupDefinitions([Id]),
	...
	[Lookup3DefinitionId]				INT				CONSTRAINT [FK_ContractDefinitions__Lookup3DefinitionId] REFERENCES dbo.LookupDefinitions([Id]),
	...
	[Lookup4DefinitionId]				INT				CONSTRAINT [FK_ContractDefinitions__Lookup4DefinitionId] REFERENCES dbo.LookupDefinitions([Id]),
