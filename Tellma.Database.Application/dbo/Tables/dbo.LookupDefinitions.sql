...
(
	...
	[Code]						NVARCHAR (50)	NOT NULL CONSTRAINT [UQ_LookupDefinitions] UNIQUE,
	...
	[SavedById]					INT				NOT NULL CONSTRAINT [FK_LookupDefinitions__SavedById] REFERENCES [dbo].[Users] ([Id]),
