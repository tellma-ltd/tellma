...
(
	...
	CONSTRAINT [UQ_LookupDefinitionReportDefinitions__LookupDefinitionId_ReportDefinitionId] UNIQUE ([LookupDefinitionId], [ReportDefinitionId]),
	[Name]					NVARCHAR (255),
	[Name2]					NVARCHAR (255),
	[Name3]					NVARCHAR (255),
	[Index]					INT				NOT NULL,
	[SavedById]				INT				NOT NULL CONSTRAINT [FK_LookupDefinitionReportDefinitions__SavedById] REFERENCES [dbo].[Users] ([Id]),
