CREATE TABLE [dbo].[Workflows] (
	...
	[FromState]			SMALLINT			NOT NULL CONSTRAINT [CK_Workflows__FromState] CHECK (0 <= [FromState]),
	-- Must be a positive state
	[ToState]			SMALLINT			NOT NULL,
	CONSTRAINT [CK_Workflows__FromState_ToState] CHECK([FromState] < [ToState]),
...
GO
CREATE UNIQUE INDEX [IX_Workflows__LineDefinitionId_FromState] ON dbo.Workflows([LineDefinitionId], [FromState]);
GO