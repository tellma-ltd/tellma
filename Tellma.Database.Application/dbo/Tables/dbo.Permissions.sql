CREATE TABLE [dbo].[Permissions] (
	...
	[Action]		NVARCHAR (255)		NOT NULL CONSTRAINT [CK_Permissions__Level] CHECK ([Action] IN (N'Read', N'Update', N'Delete', N'IsActive', N'ResendInvitationEmail', N'State', N'All')),
