...
(
	...
	[RelationId]			INT CONSTRAINT [FK_AccountBalances__RelationId] REFERENCES dbo.[Relations]([Id]),
	...
	CONSTRAINT [UX_AccountBalances] UNIQUE([AccountId], [CenterId], [RelationId], [ResourceId], [CurrencyId]),
