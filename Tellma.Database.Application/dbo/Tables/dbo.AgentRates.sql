CREATE TABLE [dbo].[AgentRates] (
	...
	[AgentId]		INT					NOT NULL CONSTRAINT [FK_AgentRates__AgentId] REFERENCES dbo.Agents([Id]),
	[ResourceId]	INT					NOT NULL CONSTRAINT [FK_AgentRates__ResourceId] REFERENCES dbo.Resources([Id]),
	[UnitId]		INT					NOT NULL CONSTRAINT [FK_AgentRates__UnitId] REFERENCES dbo.MeasurementUnits([Id]),
