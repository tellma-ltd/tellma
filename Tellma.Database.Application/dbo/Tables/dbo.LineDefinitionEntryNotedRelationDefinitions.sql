...
(
	...
	[CreatedById]			INT					NOT NULL CONSTRAINT [FK_LineDefinitionEntryNotedRelationDefinitions__CreatedById] REFERENCES [dbo].[Users] ([Id]),
	[ModifiedAt]			DATETIMEOFFSET(7)	NOT NULL DEFAULT SYSDATETIMEOFFSET(),
	[ModifiedById]			INT					NOT NULL CONSTRAINT [FK_LineDefinitionEntryNotedRelationDefinitions__ModifiedById] REFERENCES [dbo].[Users] ([Id]),
);