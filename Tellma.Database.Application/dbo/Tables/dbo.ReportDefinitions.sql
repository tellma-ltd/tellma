...
(
	...
	[CreatedById]						INT	NOT NULL CONSTRAINT [FK_ReportDefinitions__CreatedById] REFERENCES [dbo].[Users] ([Id]),
	[ModifiedAt]						DATETIMEOFFSET(7)	NOT NULL DEFAULT SYSDATETIMEOFFSET(), 
	[ModifiedById]						INT	NOT NULL CONSTRAINT [FK_ReportDefinitions__ModifiedById] REFERENCES [dbo].[Users] ([Id])
)
