	...
	[LineType]					TINYINT			NOT NULL, -- 20: T for P, 40: Plan, 60:T for E, 80:Model, 100: Event, 120: Regulatory
	...
	[SignValidateScript]		NVARCHAR (MAX), -- to store SQL code that validates the line in the sign pipeline
	[UnsignValidateScript]		NVARCHAR (MAX), -- to store SQL code that validates the line in the unsign pipeline
