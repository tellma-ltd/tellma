CREATE TABLE [dbo].[AccountTypeNotedRelationDefinitions] (
	...
	-- Audit details
	[SavedById]			INT				NOT NULL DEFAULT CONVERT(INT, SESSION_CONTEXT(N'UserId')) CONSTRAINT [FK_AccountTypeNotedRelationDefinitions__SavedById] REFERENCES [dbo].[Users] ([Id]),
