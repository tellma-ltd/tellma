CREATE FUNCTION bll.fn_ResourceDefinitionCode_Prefix_CodeWidth__NewCode (
...
AS
BEGIN
	DECLARE @DefinitionId INT = (SELECT [Id] FROM dbo.ResourceDefinitions WHERE [Code] = @DefinitionCode);
