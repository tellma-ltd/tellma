...
(
	...
	INSERT INTO @EmployeeProfiles([EmployeeId], [CenterId], [AgentId], [NotedResourceId], [EntryTypeId])
	SELECT [NotedAgentId0], [CenterId0], [AgentId0], [NotedResourceId0], [EntryTypeId0]
