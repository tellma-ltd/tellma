...
SET NOCOUNT ON;
    ...
    SELECT DISTINCT TOP(@Top)
		...
		[dbo].[fn_Localize](CD.[TitleSingular], CD.[TitleSingular2], CD.[TitleSingular3]) AS [RelationDefinition],
		[dbo].[fn_Localize](C.[Name], C.[Name2], C.[Name3]) AS [Relation],
