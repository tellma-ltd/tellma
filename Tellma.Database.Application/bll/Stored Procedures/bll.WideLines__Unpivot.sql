...
AS
	...
	(
			[Index],[LineIndex],[DocumentIndex],[Id],[EntryNumber],[Direction],[AccountId],[CurrencyId],[AgentId],[ResourceId],[ResponsibilityCenterId],
	...
	SELECT 3*[Index],[Index],[DocumentIndex],[Id],0,[Direction0],[AccountId0],[CurrencyId0],[AgentId0],[ResourceId0],[ResponsibilityCenterId0],
	...
	UNION
	SELECT 3*[Index] + 1,[Index],[DocumentIndex],[Id],1,[Direction1],[AccountId1],[CurrencyId1],[AgentId1],[ResourceId1],[ResponsibilityCenterId1],
	...
	UNION
	SELECT 3*[Index] + 2,[Index],[DocumentIndex],[Id],2,[Direction2],[AccountId2],[CurrencyId2],[AgentId2],[ResourceId2],[ResponsibilityCenterId2],
