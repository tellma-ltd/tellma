...
AS
	...
	(
			...
			[CurrencyId],[EntryTypeId],	[DueDate],	[Value], [MonetaryValue], [Count], [Mass], [Volume], [Time], [ExternalReference], [AdditionalReference], [NotedAgentId], [NotedAgentName], [NotedAmount], [NotedDate])
	SELECT 3*[Index], [Index],	[DocumentIndex], [Id],		0,		[Direction0],[AgentId0],[ResourceId0],[ResponsibilityCenterId0],
			...
			[CurrencyId0],[EntryTypeId0],[DueDate0],[Value0], [MonetaryValue0], [Count0], [Mass0], [Volume0], [Time0],  [ExternalReference0], [AdditionalReference0], [NotedAgentId0], [NotedAgentName0], [NotedAmount0], [NotedDate0]
	...
	SELECT 3*[Index] + 1, [Index],	[DocumentIndex], [Id],		1,	[Direction1],[AgentId1],[ResourceId1],[ResponsibilityCenterId1],
			...
			[CurrencyId1],[EntryTypeId1],[DueDate1],[Value1], [MonetaryValue1], [Count1], [Mass1], [Volume1], [Time1], [ExternalReference1], [AdditionalReference1], [NotedAgentId1], [NotedAgentName1], [NotedAmount1], [NotedDate1]
	FROM @WideLines WL JOIN LD ON WL.DefinitionId = LD.LineDefinitionId
	...
	SELECT 3*[Index] + 2, [Index],	[DocumentIndex], [Id],		2,	[Direction2],[AgentId2],[ResourceId2],[ResponsibilityCenterId2],
			...
			[CurrencyId2],[EntryTypeId2],	[DueDate2],	[Value2],[MonetaryValue2], [Count2], [Mass2], [Volume2], [Time2], [ExternalReference2], [AdditionalReference2], [NotedAgentId2], [NotedAgentName2], [NotedAmount2], [NotedDate2]
	FROM @WideLines WL JOIN LD ON WL.DefinitionId = LD.LineDefinitionId
