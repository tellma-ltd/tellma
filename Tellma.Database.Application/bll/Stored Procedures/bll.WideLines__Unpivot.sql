...
AS
	...
	(
			[Index],[LineIndex],[DocumentIndex],[Id],[Direction],[AccountId],[CurrencyId],[AgentId],[NotedAgentId],[ResourceId],[NotedResourceId],[CenterId],
	...
	SELECT	0,		WL.[Index],	[DocumentIndex],[Id0],[Direction0],[AccountId0],[CurrencyId0],[AgentId0],[NotedAgentId0],[ResourceId0],[NotedResourceId0],[CenterId0],
	...
	UNION
	SELECT	1,		WL.[Index],	[DocumentIndex],[Id1],[Direction1],[AccountId1],[CurrencyId1],[AgentId1],[NotedAgentId1],[ResourceId1],[NotedResourceId1],[CenterId1],
	...
	UNION
	SELECT	2,		WL.[Index],	[DocumentIndex],[Id2],[Direction2],[AccountId2],[CurrencyId2],[AgentId2],[NotedAgentId2],[ResourceId2],[NotedResourceId2],[CenterId2],
	...
	UNION
	SELECT	3,		WL.[Index],	[DocumentIndex],[Id3],[Direction3],[AccountId3],[CurrencyId3],[AgentId3],[NotedAgentId3],[ResourceId3],[NotedResourceId3],[CenterId3],
	...
	UNION
	SELECT	4,		WL.[Index],	[DocumentIndex],[Id4],[Direction4],[AccountId4],[CurrencyId4],[AgentId4],[NotedAgentId4],[ResourceId4],[NotedResourceId4],[CenterId4],
	...
	UNION
	SELECT	5,		WL.[Index],	[DocumentIndex],[Id5],[Direction5],[AccountId5],[CurrencyId5],[AgentId5],[NotedAgentId5],[ResourceId5],[NotedResourceId5],[CenterId5],
	...
	UNION
	SELECT	6,		WL.[Index],	[DocumentIndex],[Id6],[Direction6],[AccountId6],[CurrencyId6],[AgentId6],[NotedAgentId6],[ResourceId6],[NotedResourceId6],[CenterId6],
	...
	UNION
	SELECT	7,		WL.[Index],	[DocumentIndex],[Id7],[Direction7],[AccountId7],[CurrencyId7],[AgentId7],[NotedAgentId7],[ResourceId7],[NotedResourceId7],[CenterId7],
	...
	UNION
	SELECT	8,		WL.[Index],	[DocumentIndex],[Id8],[Direction8],[AccountId8],[CurrencyId8],[AgentId8],[NotedAgentId8],[ResourceId8],[NotedResourceId8],[CenterId8],
	...
	UNION
	SELECT	9,		WL.[Index],	[DocumentIndex],[Id9],[Direction9],[AccountId9],[CurrencyId9],[AgentId9],[NotedAgentId9],[ResourceId9],[NotedResourceId9],[CenterId9],
	...
	UNION
	SELECT	10,		WL.[Index],	[DocumentIndex],[Id10],[Direction10],[AccountId10],[CurrencyId10],[AgentId10],[NotedAgentId10],[ResourceId10],[NotedResourceId10],[CenterId10],
	...
	UNION
	SELECT	11,		WL.[Index],	[DocumentIndex],[Id11],[Direction11],[AccountId11],[CurrencyId11],[AgentId11],[NotedAgentId11],[ResourceId11],[NotedResourceId11],[CenterId11],
	...
	UNION
	SELECT	12,		WL.[Index],	[DocumentIndex],[Id12],[Direction12],[AccountId12],[CurrencyId12],[AgentId12],[NotedAgentId12],[ResourceId12],[NotedResourceId12],[CenterId12],
	...
	UNION
	SELECT	13,		WL.[Index],	[DocumentIndex],[Id13],[Direction13],[AccountId13],[CurrencyId13],[AgentId13],[NotedAgentId13],[ResourceId13],[NotedResourceId13],[CenterId13],
	...
	UNION
	SELECT	14,		WL.[Index],	[DocumentIndex],[Id14],[Direction14],[AccountId14],[CurrencyId14],[AgentId14],[NotedAgentId14],[ResourceId14],[NotedResourceId14],[CenterId14],
	...
	UNION
	SELECT	15,		WL.[Index],	[DocumentIndex],[Id15],[Direction15],[AccountId15],[CurrencyId15],[AgentId15],[NotedAgentId15],[ResourceId15],[NotedResourceId15],[CenterId15],
