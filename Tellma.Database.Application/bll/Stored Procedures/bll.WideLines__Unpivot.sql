...
AS
	...
	SELECT	0,		[Index],	[DocumentIndex],[Id],[Direction0],[AccountId0],[CurrencyId0],[AgentId0],[ResourceId0],[ResponsibilityCenterId0],
	...
	UNION
	SELECT	1,		[Index],	[DocumentIndex],[Id],[Direction1],[AccountId1],[CurrencyId1],[AgentId1],[ResourceId1],[ResponsibilityCenterId1],
	...
	UNION
	SELECT	2,		[Index],	[DocumentIndex],[Id],[Direction2],[AccountId2],[CurrencyId2],[AgentId2],[ResourceId2],[ResponsibilityCenterId2],
