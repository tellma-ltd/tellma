...
AS
	...
	(
			[Index],[LineIndex],[DocumentIndex],[Id],[Direction],[AccountId],[CurrencyId],[RelationId],[NotedRelationId],[ResourceId],[CenterId],
	...
	SELECT	0,		WL.[Index],	[DocumentIndex],[Id0],[Direction0],[AccountId0],[CurrencyId0],[RelationId0],[NotedRelationId0],[ResourceId0],[CenterId0],
	...
	UNION
	SELECT	1,		WL.[Index],	[DocumentIndex],[Id1],[Direction1],[AccountId1],[CurrencyId1],[RelationId1],[NotedRelationId1],[ResourceId1],[CenterId1],
	...
	UNION
	SELECT	2,		WL.[Index],	[DocumentIndex],[Id2],[Direction2],[AccountId2],[CurrencyId2],[RelationId2],[NotedRelationId2],[ResourceId2],[CenterId2],
	...
	UNION
	SELECT	3,		WL.[Index],	[DocumentIndex],[Id3],[Direction3],[AccountId3],[CurrencyId3],[RelationId3],[NotedRelationId3],[ResourceId3],[CenterId3],
	...
	UNION
	SELECT	4,		WL.[Index],	[DocumentIndex],[Id4],[Direction4],[AccountId4],[CurrencyId4],[RelationId4],[NotedRelationId4],[ResourceId4],[CenterId4],
	...
	UNION
	SELECT	5,		WL.[Index],	[DocumentIndex],[Id5],[Direction5],[AccountId5],[CurrencyId5],[RelationId5],[NotedRelationId5],[ResourceId5],[CenterId5],
	...
	UNION
	SELECT	6,		WL.[Index],	[DocumentIndex],[Id6],[Direction6],[AccountId6],[CurrencyId6],[RelationId6],[NotedRelationId6],[ResourceId6],[CenterId6],
	...
	UNION
	SELECT	7,		WL.[Index],	[DocumentIndex],[Id7],[Direction7],[AccountId7],[CurrencyId7],[RelationId7],[NotedRelationId7],[ResourceId7],[CenterId7],
	...
	UNION
	SELECT	8,		WL.[Index],	[DocumentIndex],[Id8],[Direction8],[AccountId8],[CurrencyId8],[RelationId8],[NotedRelationId8],[ResourceId8],[CenterId8],
	...
	UNION
	SELECT	9,		WL.[Index],	[DocumentIndex],[Id9],[Direction9],[AccountId9],[CurrencyId9],[RelationId9],[NotedRelationId9],[ResourceId9],[CenterId9],
	...
	UNION
	SELECT	10,		WL.[Index],	[DocumentIndex],[Id10],[Direction10],[AccountId10],[CurrencyId10],[RelationId10],[NotedRelationId10],[ResourceId10],[CenterId10],
	...
	UNION
	SELECT	11,		WL.[Index],	[DocumentIndex],[Id11],[Direction11],[AccountId11],[CurrencyId11],[RelationId11],[NotedRelationId11],[ResourceId11],[CenterId11],
	...
	UNION
	SELECT	12,		WL.[Index],	[DocumentIndex],[Id12],[Direction12],[AccountId12],[CurrencyId12],[RelationId12],[NotedRelationId12],[ResourceId12],[CenterId12],
	...
	UNION
	SELECT	13,		WL.[Index],	[DocumentIndex],[Id13],[Direction13],[AccountId13],[CurrencyId13],[RelationId13],[NotedRelationId13],[ResourceId13],[CenterId13],
	...
	UNION
	SELECT	14,		WL.[Index],	[DocumentIndex],[Id14],[Direction14],[AccountId14],[CurrencyId14],[RelationId14],[NotedRelationId14],[ResourceId14],[CenterId14],
	...
	UNION
	SELECT	15,		WL.[Index],	[DocumentIndex],[Id15],[Direction15],[AccountId15],[CurrencyId15],[RelationId15],[NotedRelationId15],[ResourceId15],[CenterId15],
