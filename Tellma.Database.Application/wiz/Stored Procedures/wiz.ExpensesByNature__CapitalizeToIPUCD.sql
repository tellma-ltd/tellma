CREATE PROCEDURE [wiz].[ExpensesByNature__CapitalizeToIPUCD]
--[wiz].[ExpensesByNature__CapitalizeToIPUCD] @BusinessUnitId = 74, @ToDate = N'2021-07-07' --  -- Adama
-- Assumption: For each IPUCD we open a cost center and a resource
-- It is the user responsibility to make sure the respons. center and the resource are compatible
--DECLARE
	@DocumentIndex	INT = 0,
	@BusinessUnitId INT = 74,
	@ToDate			DATE = N'2021-07-07' ,
	@AbstractSupplierCode NVARCHAR (50) = N'0'
AS
	DECLARE @BSAccountTypeConcept NVARCHAR (255) = N'InvestmentPropertyUnderConstructionOrDevelopment'
