...
AS BEGIN
	...
	INSERT INTO @DocumentSignatures(
		[LineId], [ToState], [RuleType], [RoleId], [UserId], [ContractId], [LineSignatureId], [SignedById], [SignedAt], [OnBehalfOfUserId], [LastUnsignedState], [LastNegativeState], [CanSign], [ProxyRoleId], [CanSignOnBehalf], [ReasonId], [ReasonDetails])
	SELECT
		[LineId], [ToState], [RuleType], [RoleId], [UserId], [ContractId], [LineSignatureId], [SignedById], [SignedAt], [OnBehalfOfUserId], [LastUnsignedState], [LastNegativeState], [CanSign], [ProxyRoleId], [CanSignOnBehalf], [ReasonId], [ReasonDetails]
