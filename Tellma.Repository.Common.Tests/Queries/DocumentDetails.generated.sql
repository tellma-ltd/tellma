...
LEFT JOIN [map].[Users]() As [P10] ON [P].[CreatedById] = [P10].[Id]
LEFT JOIN [map].[Users]() As [P11] ON [P].[ModifiedById] = [P11].[Id]
LEFT JOIN [map].[Users]() As [P12] ON [P].[AssigneeId] = [P12].[Id]
LEFT JOIN [map].[Lookups]() As [P13] ON [P].[Lookup1Id] = [P13].[Id]
LEFT JOIN [map].[Lookups]() As [P14] ON [P].[Lookup2Id] = [P14].[Id]
WHERE (([P].[DefinitionId] = 46)) AND ([P].[Id] = @Param__1)
ORDER BY [P].[Id] ASC
OPTION(RECOMPILE) 
