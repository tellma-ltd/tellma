    ...
    if (!_cache[key]) {
        ...
        const entityDesc: EntityDescriptor = {
            ...
            properties: {
                ...
                Decimal1: { datatype: 'numeric', control: 'number', label: () => trx.instant('Entity_Decimal1'), minDecimalPlaces: 0, maxDecimalPlaces: 4, noSeparator: false, isRightAligned: true },
                Decimal2: { datatype: 'numeric', control: 'number', label: () => trx.instant('Entity_Decimal2'), minDecimalPlaces: 0, maxDecimalPlaces: 4, noSeparator: false, isRightAligned: true },
                Decimal3: { datatype: 'numeric', control: 'number', label: () => trx.instant('Entity_Decimal3'), minDecimalPlaces: 0, maxDecimalPlaces: 4, noSeparator: false, isRightAligned: true },
                Decimal4: { datatype: 'numeric', control: 'number', label: () => trx.instant('Entity_Decimal4'), minDecimalPlaces: 0, maxDecimalPlaces: 4, noSeparator: false, isRightAligned: true },
