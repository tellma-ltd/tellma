...
import { AgentDefinitionReportDefinition as AgentDefinitionReportDefinition, AgentDefinitionReportDefinitionForSave } from './agent-definition-report-definition';
import { TimeGranularity } from './base/metadata-types';

export interface AgentDefinitionForSave<TReportDefinition = AgentDefinitionReportDefinitionForSave> extends EntityForSave {
    Code?: string;
...
export interface AgentDefinition extends AgentDefinitionForSave<AgentDefinitionReportDefinition> {
...
export function metadata_AgentDefinition(wss: WorkspaceService, trx: TranslateService): EntityDescriptor {
    ...
    if (!_cache) {
        ...
        const entityDesc: EntityDescriptor = {
            ...
            titleSingular: () => trx.instant('AgentDefinition'),
            titlePlural: () => trx.instant('AgentDefinitions'),
            select: _select,
            apiEndpoint: 'agent-definitions',
            masterScreenUrl: 'agent-definitions',
            ...
            properties: {
                ...
                DateOfBirthVisibility: visibilityPropDescriptor('Agent_DateOfBirth', trx),
