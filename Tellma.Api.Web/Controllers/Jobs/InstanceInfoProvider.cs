...
namespace Tellma.Controllers.Jobs
{
    public class InstanceInfoProvider
    {
        ...
        /// </summary>
        public IEnumerable<int> AdoptedTenantIds => _adoptedTenantIds;

        /// <summary>
        /// All the tenant Ids currently adopted by the current instance
        /// </summary>
        private readonly ConcurrentBag<int> _adoptedTenantIds = new ConcurrentBag<int>();

        /// <summary>
        /// Adds the new collection of orphans to the current instance's list of adoptions
        /// </summary>
        public void AddNewlyAdoptedOrphans(IEnumerable<int> orphans)
        {
