...
{
    [Display(Name = "WorkflowSignature", GroupName = "WorkflowSignatures")]
    public class WorkflowSignatureForSave : EntityWithKey<int>
    {
        ...
        [ChoiceList(new object[] { 
                ...
                RuleTypes.Public }, 
            new string[] { 
                RuleTypeNames.ByRole, 
                RuleTypeNames.ByCustodian, 
        ...
        [ChoiceList(new object[] {
                PredicateTypes.ValueGreaterOrEqual },
            new string[] { 
                PredicateTypeNames.ValueGreaterOrEqual 
            })]
