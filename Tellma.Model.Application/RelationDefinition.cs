...
{
    [Display(Name = "RelationDefinition", GroupName = "RelationDefinitions")]
    public class RelationDefinitionForSave<TReportDefinition> : EntityWithKey<int>
    {
        ...
        [DefinitionLabelDisplay(Name = "Entity_Relation1")]
        [StringLength(50)]
        ...
        [DefinitionLabelDisplay(Name = "Relation_ExternalReference")]
        [StringLength(50)]
