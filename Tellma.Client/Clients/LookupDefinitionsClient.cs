...
namespace Tellma.Client
{
    public class LookupDefinitionsClient : CrudClientBase<LookupDefinitionForSave, LookupDefinition, int>
    {
        ...
        public async Task<EntitiesResult<LookupDefinition>> UpdateState(List<int> ids, Request<UpdateStateArguments> request, CancellationToken cancellation = default)
