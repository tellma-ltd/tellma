...
{
    public class Tests_Resources : Scenario_01
    {
        public Tests_Resources(Scenario_01_WebApplicationFactory factory, ITestOutputHelper output) : base(factory, output)
        {
        }
        ...
        public async Task Test07()
        {
            ...
            Assert.Equal(entity.Memo, responseDto.Memo);
        }
