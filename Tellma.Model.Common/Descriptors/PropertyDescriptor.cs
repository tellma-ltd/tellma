...
namespace Tellma.Model.Common
{
    ...
    public class PropertyDescriptor
    {
            ...
            Func<Entity, int?> indexPropGetter = null)
        {
            ...
            IncludesTime = propInfo.GetCustomAttribute<DataTypeAttribute>(inherit: true)?.DataType == DataType.DateTime;

            #endregion

            #region Not Null

            IsNotNull = propInfo.GetCustomAttribute<RequiredAttribute>(inherit: true) != null;
