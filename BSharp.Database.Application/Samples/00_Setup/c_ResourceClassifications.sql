...
-- Financial resources
(N'FinancialAssets',							N'Financial assets',							N'/2/',			1,37),
(N'CashAndCashEquivalents',						N'Cash and cash equivalents',					N'/3/',			0,38),
	(N'Cash',									N'Cash',										N'/3/1/',		1,39),
	(N'CashEquivalents',						N'Cash equivalents',							N'/3/2/',		1,40),

-- Consumables and services
(N'ExpenseByNature',							N'Expenses, by nature',							N'/4/',			0,41),
	(N'RawMaterialsAndConsumablesUsed',			N'Raw materials and consumables used',			N'/4/1/',		1,42),
	(N'CostOfMerchandiseSold',					N'Cost of merchandise sold',					N'/4/2/',		1,43),
		(N'CostOfPurchasedEnergySold',			N'Cost of purchased energy sold',				N'/4/2/1/',		1,44),

	(N'ServicesExpense',						N'Services',									N'/4/3/',		1,45),
		(N'InsuranceExpense',					N'Insurance',									N'/4/3/1/',		1,46),
		(N'ProfessionalFeesExpense',			N'Professional services',						N'/4/3/2/',		1,47),
		(N'TransportationExpense',				N'Transportation',								N'/4/3/3/',		1,48),
		(N'BankAndSimilarCharges',				N'Bank services',								N'/4/3/4/',		1,49),
		(N'EnergyTransmissionCharges',			N'Energy transmission',							N'/4/3/5/',		1,50),
		(N'TravelExpense',						N'Travel',										N'/4/3/6/',		1,51),
		(N'CommunicationExpense',				N'Communication',								N'/4/3/7/',		1,52),
		(N'UtilitiesExpense',					N'Utilities',									N'/4/3/8/',		1,53),
		(N'AdvertisingExpense',					N'Advertising',									N'/4/3/9/',		1,54),

	(N'EmployeeBenefitsExpense',				N'Employee benefits expense',					N'/4/4/',		0,55),
		(N'ShorttermEmployeeBenefitsExpense',	N'Short-term employee benefits expense',		N'/4/4/1/',		0,56),
			(N'WagesAndSalaries',				N'Wages and salaries',							N'/4/4/1/1/',	1,57),
			(N'SocialSecurityContributions',	N'Social security contributions',				N'/4/4/1/2/',	1,58),
			(N'OtherShorttermEmployeeBenefits',	N'Other short-term employee benefits',			N'/4/4/1/3/',	1,59),
	...
	(N'DepreciationAmortisationAndImpairmentLossReversalOfImpairmentLossRecognisedInProfitOrLoss',
												N'Depreciation, amortisation and impairment loss (reversal of impairment loss) recognised in profit or loss',
																								N'/4/5/',		0,61),
		(N'DepreciationAndAmortisationExpense',N'Depreciation and amortisation expense',		N'/4/5/1/',		0,62),
			(N'DepreciationExpense',			N'Depreciation expense',						N'/4/5/1/1/',	1,63),
			(N'AmortisationExpense',			N'Amortisation expense',						N'/4/5/1/2/',	1,64),
			(N'ImpairmentLossReversalOfImpairmentLossRecognisedInProfitOrLoss',
												N'Impairment loss (reversal of impairment loss) recognised in profit or loss',
																								N'/4/6/',		1,65),
	(N'TaxExpenseOtherThanIncomeTaxExpense',	N'Tax expense other than income tax expense',	N'/4/7/',		1,66),
		(N'PropertyTaxExpense',					N'Property tax expense',						N'/4/7/1/',		1,67),
	(N'OtherExpenseByNature',					N'Other expenses, by nature',					N'/4/8/',		1,68);
--==================================================================================================================================
