CREATE TABLE [dbo].[AccountTypesEntryTypes] (
	[AccountTypeId]	NVARCHAR (50)	CONSTRAINT [FK_AccountTypesEntryTypes__AccountTypeId] FOREIGN KEY ([AccountTypeId]) REFERENCES [dbo].[AccountTypes] ([Id]) ON DELETE CASCADE, 
