CREATE TABLE [dbo].[Accounts] (
	...
	[DefaultDebitIfrsEntryClassificationId]		NVARCHAR (255)		CONSTRAINT [FK_Accounts__DebitIfrsNoteId] FOREIGN KEY ([DefaultDebitIfrsEntryClassificationId]) REFERENCES [dbo].[IfrsEntryClassifications] ([Id]),
	[DefaultCreditIfrsEntryClassificationId]	NVARCHAR (255)		CONSTRAINT [FK_Accounts__CreditIfrsNoteId] FOREIGN KEY ([DefaultCreditIfrsEntryClassificationId]) REFERENCES [dbo].[IfrsEntryClassifications] ([Id]),
