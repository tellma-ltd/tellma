...
(
	...
	[GLAccountId]					INT					CONSTRAINT [FK_Accounts__GLAcccountId] FOREIGN KEY ([GLAccountId]) REFERENCES [dbo].[GLAccounts] ([Id]),
	[SubAccountId]					INT					NOT NULL DEFAULT 0,
	[AccountDefinitionId]			NVARCHAR (50)		NOT NULL DEFAULT N'simple-accounts' CONSTRAINT [FK_AccountMappings__AccountDefinitionId] FOREIGN KEY ([AccountDefinitionId]) REFERENCES [dbo].[AccountDefinitions] ([Id]),
