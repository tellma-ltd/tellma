...
-- Trade Creditors: same story
	...
	[AccountDefinitionId]			NVARCHAR (50)		NOT NULL DEFAULT N'gl-accounts' CONSTRAINT [FK_Accounts___AccountDefinitionId] FOREIGN KEY ([AccountDefinitionId]) REFERENCES [dbo].[AccountDefinitions] ([Id]),
	...
	[AccountTypeId]					NVARCHAR (255)		NOT NULL CONSTRAINT [FK_Accounts___AccountTypeId] FOREIGN KEY ([AccountTypeId]) REFERENCES [dbo].[AccountTypes] ([Id]),
	...
	[CustodianId]					INT					CONSTRAINT [FK_Accounts___CustodianId] FOREIGN KEY ([CustodianId]) REFERENCES [dbo].[Agents] ([Id]),
	[LocationId]					INT					CONSTRAINT [FK_Accounts___LocationId] FOREIGN KEY ([LocationId])	REFERENCES [dbo].[Locations] ([Id]),
