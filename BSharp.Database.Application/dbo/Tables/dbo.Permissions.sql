CREATE TABLE [dbo].[Permissions] (
	...
	[Action]		NVARCHAR (255)		NOT NULL CONSTRAINT [CK_Permissions__Level] CHECK ([Action] IN (N'Read', N'Update', N'Delete', N'IsActive', N'ResendInvitationEmail', N'All')),
	[Criteria]		NVARCHAR(1024),		-- compiles into LINQ expression to filter the applicability
	[Mask]			NVARCHAR(1024),
	[Memo]			NVARCHAR (255),
	--[SavedAt]			AS [ValidFrom] AT TIME ZONE 'UTC',
	[SavedById]			INT					NOT NULL DEFAULT CONVERT(INT, SESSION_CONTEXT(N'UserId')) CONSTRAINT [FK_Permissions__SavedById] FOREIGN KEY ([SavedById]) REFERENCES [dbo].[Users] ([Id]),
