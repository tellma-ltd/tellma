	...
	(
		...
		THEN
			UPDATE SET
				...
				t.[IfrsClassificationId]					= s.[IfrsAccountId],
				t.[Name]							= s.[Name],
				t.[Name2]							= s.[Name2],
				t.[Name3]							= s.[Name3],
				t.[Code]							= s.[Code],
				...
				t.[AgentId]							= s.[AgentId],
				t.[DefaultDebitIfrsEntryClassificationId]				= s.[DefaultIfrsNoteId],
		...
		WHEN NOT MATCHED THEN
			INSERT ([CustomClassificationId], [IfrsClassificationId],
				[Name], [Name2], [Name3], [Code], [PartyReference], [AgentId],
				[DefaultDebitIfrsEntryClassificationId], [DefaultResponsibilityCenterId], [DefaultResourceId])
