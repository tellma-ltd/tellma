	...
	(
		...
		WHEN NOT MATCHED THEN
			INSERT ([ResourceDefinitionId], [ResourceClassificationId], [Name], [Name2], [Name3],
				...
				-- [UnitMonetaryValue], [UnitMass], [UnitVolume], [UnitArea], [UnitLength], [UnitTime], [UnitCount], 
				[Code], [Memo], [CustomsReference] , [PreferredSupplierId],
			...
			VALUES (@ResourceDefinitionId, s.[ResourceClassificationId], s.[Name], s.[Name2], s.[Name3],
				s.[CurrencyId], s.[MassUnitId], s.[VolumeUnitId],s.[AreaUnitId],s.[LengthUnitId], s.[TimeUnitId], s.[CountUnitId],
				-- s.[UnitMonetaryValue], s.[UnitMass], s.[UnitVolume], s.[UnitArea], s.[UnitLength], s.[UnitTime], s.[UnitCount], 
				s.[Code], s.[Memo], s.[CustomsReference], s.[PreferredSupplierId],
