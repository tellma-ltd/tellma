...
SET NOCOUNT ON;
	...
	(
		...
		WHEN NOT MATCHED THEN
			INSERT ([ParentId],		[Name],		[Name2], [Name3], [Code],	[Node],		[ResourceDefinitionId], [IsAssignable])
			VALUES (s.[ParentId], s.[Name], s.[Name2], s.[Name3], s.[Code], s.[Node], s.[ResourceDefinitionId], s.[IsAssignable])
