    ...
    public abstract class ApiClientBase
    {
        ...
        protected virtual IFactService FactServiceByCollectionName(IServiceProvider services, string collection, int? definitionId = null)
        {
            return collection switch
            {
                ...
                nameof(NotificationCommand) => services.GetRequiredService<NotificationCommandsService>(),
                nameof(NotificationTemplate) => services.GetRequiredService<NotificationTemplatesService>(),
