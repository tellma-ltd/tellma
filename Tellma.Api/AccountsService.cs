...
namespace Tellma.Api
{
    public class AccountsService : CrudServiceBase<AccountForSave, Account, int>
    {
        ...
        {
            SaveResult result = await _behavior.Repository.Accounts__Save(
                entities: entities,
                returnIds: returnIds,
        ...
        {
            DeleteResult result = await _behavior.Repository.Accounts__Delete(
                ids: ids,
                validateOnly: ModelState.IsError,
                top: ModelState.RemainingErrors,
                userId: UserId);
        ...
        private async Task<(List<Account>, Extras)> SetIsActive(List<int> ids, ActionArguments args, bool isActive)
        {
            ...
            OperationResult result = await _behavior.Repository.Accounts__Activate(
                    ids: ids,
                    isActive: isActive,
                    validateOnly: ModelState.IsError,
                    top: ModelState.RemainingErrors,
