...
namespace Tellma.Api
{
    public class NotificationCommandsService : FactGetByIdServiceBase<NotificationCommand, int>
    {
        ...
        public NotificationCommandsService(ApplicationFactServiceBehavior behavior, IPermissionsCache permissionsCache, FactServiceDependencies deps) : base(deps)
        {
            _behavior = behavior;
        ...
        protected override async Task<IEnumerable<AbstractPermission>> UserPermissions(string action, CancellationToken cancellation)
        {
            ...
            // Get all permissions pertaining to notification commands
            string prefix = $"{View}/";
            ...
            foreach (var permission in templateSpecificPermissions.Where(e => e.View != "all"))
            {
                ...
                string definitionPredicate = $"{nameof(NotificationCommand.TemplateId)} eq {templateId}";
