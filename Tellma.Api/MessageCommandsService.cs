...
{
    public class MessageCommandsService : FactGetByIdServiceBase<MessageCommand, int>
    {
        ...
        protected override string View => "message-commands";
        ...
        protected override async Task<IEnumerable<AbstractPermission>> UserPermissions(string action, CancellationToken cancellation)
        {
            ...
            // Get all permissions pertaining to message commands
            string prefix = $"{View}/";
            ...
            foreach (var permission in templateSpecificPermissions.Where(e => e.View != "all"))
            {
                ...
                string definitionPredicate = $"{nameof(MessageCommand.TemplateId)} eq {templateId}";
