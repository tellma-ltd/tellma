...
namespace Tellma.Api.Templating
{
    ...
    {
        public static readonly List<string> _keywords = new() { "null", "true", "false" };

        public string VariableName { get; set; }

        public override IAsyncEnumerable<Path> ComputeSelect(EvaluationContext ctx)
        {
            bool found = ctx.TryGetVariable(VariableName, out EvaluationVariable variableEntry);
        ...
        {
            if (ctx.TryGetVariable(VariableName, out EvaluationVariable variableEntry))
            {
