...
namespace Tellma.Api.Templating
{
    ...
    public static class NumericUtil
    {
        ...
        /// <summary>
        /// Finds left modulo right after converting both to their common numeric type. 
        /// Throws a meaningful exception if right is equal to 0.
        /// </summary>
        /// <exception cref="TemplateException">If <paramref name="right"/> is equal to zero.</exception>
        ...
        /// <summary>
        /// Casts the numeric <paramref name="value"/> to the <paramref name="targetType"/> and returns it as an <see cref="IComparable"/>.
        /// </summary>
        /// <param name="value">The value to cast.</param>
        /// <param name="targetType">The target type to cast the value to.</param>
        /// <returns>The <paramref name="value"/> as an <see cref="IComparable"/>.</returns>
        ...
        /// <summary>
        /// All 11 numeric types supported in C#.
        /// </summary>
        public static readonly HashSet<string> _numeric = new() { _sbyte, _byte, _short, _ushort, _int, _uint, _long, _ulong, _float, _double, _decimal };
    }
}
