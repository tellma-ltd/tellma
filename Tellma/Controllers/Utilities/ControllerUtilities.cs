...
namespace Tellma.Controllers.Utilities
{
    public static class ControllerUtilities
    {
        ...
        /// <returns></returns>
        public static string PreprocessControlOptions(string control, string controlOptions, Dto.SettingsForClient settings)
        {
        ...
        public static IEnumerable<string> ValidateControlOptions(string control, string controlOptions, IStringLocalizer localizer, Dto.SettingsForClient settings, Dto.DefinitionsForClient defs)
        {
