    ...
    if (!_cache[key]) {
        ...
        const entityDesc: EntityDescriptor = {
            ...
            properties: {
                ...
                CenterId: { datatype: 'numeric', control: 'number', label: () => `${trx.instant('Document_Center')} (${trx.instant('Id')})`, minDecimalPlaces: 0, maxDecimalPlaces: 0 },
                ...
                AssignedById: { datatype: 'numeric', control: 'number', label: () => `${trx.instant('Document_AssignedBy')} (${trx.instant('Id')})`, minDecimalPlaces: 0, maxDecimalPlaces: 0 },
