  ...
  if (!_cache[key]) {
    ...
    const entityDesc: EntityDescriptor = {
      ...
      properties: {
        ...
        Lookup5Id: { datatype: 'numeric', control: 'number', label: () => `${trx.instant('Entity_Lookup5')} (${trx.instant('Id')})`, minDecimalPlaces: 0, maxDecimalPlaces: 0 },
        Lookup5: { datatype: 'entity', label: () => trx.instant('Entity_Lookup5'), control: 'Lookup', foreignKeyName: 'Lookup5Id' },
        Lookup6Id: { datatype: 'numeric', control: 'number', label: () => `${trx.instant('Entity_Lookup6')} (${trx.instant('Id')})`, minDecimalPlaces: 0, maxDecimalPlaces: 0 },
        Lookup6: { datatype: 'entity', label: () => trx.instant('Entity_Lookup6'), control: 'Lookup', foreignKeyName: 'Lookup6Id' },
        Lookup7Id: { datatype: 'numeric', control: 'number', label: () => `${trx.instant('Entity_Lookup7')} (${trx.instant('Id')})`, minDecimalPlaces: 0, maxDecimalPlaces: 0 },
        Lookup7: { datatype: 'entity', label: () => trx.instant('Entity_Lookup7'), control: 'Lookup', foreignKeyName: 'Lookup7Id' },
        Lookup8Id: { datatype: 'numeric', control: 'number', label: () => `${trx.instant('Entity_Lookup8')} (${trx.instant('Id')})`, minDecimalPlaces: 0, maxDecimalPlaces: 0 },
        ...
        AgentId: { datatype: 'numeric', control: 'number', label: () => `${trx.instant('Relation_Agent')} (${trx.instant('Id')})`, minDecimalPlaces: 0, maxDecimalPlaces: 0 },
        ...
        JobId: { datatype: 'numeric', control: 'number', label: () => `${trx.instant('Relation_Job')} (${trx.instant('Id')})`, minDecimalPlaces: 0, maxDecimalPlaces: 0 },
        BankAccountNumber: { datatype: 'string', control: 'text', label: () => trx.instant('Relation_BankAccountNumber') },
        Relation1Id: { datatype: 'numeric', control: 'number', label: () => `${trx.instant('Relation_Relation1')} (${trx.instant('Id')})`, minDecimalPlaces: 0, maxDecimalPlaces: 0 },
