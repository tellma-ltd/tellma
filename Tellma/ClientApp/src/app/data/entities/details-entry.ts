    ...
    if (ws.settings !== _settings) {
        ...
        const entityDesc: EntityDescriptor = {
            ...
            properties: {
                ...
                Count: { control: 'number', label: () => trx.instant('Entry_Count'), minDecimalPlaces: 0, maxDecimalPlaces: 4, alignment: 'right' },
                ...
                Mass: { control: 'number', label: () => trx.instant('Entry_Mass'), minDecimalPlaces: 0, maxDecimalPlaces: 4, alignment: 'right' },
                ...
                Volume: { control: 'number', label: () => trx.instant('Entry_Volume'), minDecimalPlaces: 0, maxDecimalPlaces: 4, alignment: 'right' },
                ...
                Time: { control: 'number', label: () => trx.instant('Entry_Time'), minDecimalPlaces: 0, maxDecimalPlaces: 4, alignment: 'right' },
