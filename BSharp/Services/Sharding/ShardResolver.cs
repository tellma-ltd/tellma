            ...
            if (shardConnString == null)
            {
                ...
                try
                {
                    ...
                    if (shardConnString == null)
                    {
                        ...
                        // purpose behind it is to make it easier to set-up small instances that do not require sharding 
                        ...
                        else
                        {
                            ...
                            // - Mode 1: in a "Passwords" section in a secure configuration provider, and then they are referenced in the conn string by their keys
                            ...
                            if (!string.IsNullOrWhiteSpace(shardConnBuilder.Password))
                            {
                                ...
                                // ELSE we hope that this is a valid password, or else the connection to the shardly will sadly fail.
                            }
                            else
                            {
