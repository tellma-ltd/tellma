...
namespace BSharp.Data.Model
{
    ...
    public class Translation : ModelBase
    {
        ...
        public static Translation[] TRANSLATIONS = {
            ...
            En(Constants.Server, "Error_Field0OnType1IsNotANavigationField", "Field '{0}' on type '{1}' is not a navigation field, therefore it cannot be followed by another field in the select path"),
            Ar(Constants.Server, "Error_Field0OnType1IsNotANavigationField", "الحقل ({1}) على النوع ({0}) هو حقل بسيط، وبالتالي لا يمكن أن يتبعه حقل آخر في مسارات select"),
            ...
            En(Constants.Shared, "Permission_Mask", "Mask"),
            Ar(Constants.Shared, "Permission_Mask", "حجاب"),
            ...
            En(Constants.Client, "Restricted", "Restricted Information"),
            Ar(Constants.Client, "Restricted", "معلومة محجوبة"),
