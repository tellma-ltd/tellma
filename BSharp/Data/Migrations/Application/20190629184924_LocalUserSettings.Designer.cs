...
namespace BSharp.Data.Migrations.Application
{
    ...
    [Migration("20190629184924_LocalUserSettings")]
    partial class LocalUserSettings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BSharp.Data.Model.LocalUserSetting", b =>
                {
                    b.Property<int>("TenantId")
                        .HasDefaultValueSql("CONVERT(INT, SESSION_CONTEXT(N'TenantId'))");
            ...
            modelBuilder.Entity("BSharp.Data.Model.ProductCategory", b =>
                {
                    b.Property<int>("TenantId")
                        .HasDefaultValueSql("CONVERT(INT, SESSION_CONTEXT(N'TenantId'))");
            ...
            modelBuilder.Entity("BSharp.Data.Model.ProductCategory", b =>
                {
                    ...
                    b.HasOne("BSharp.Data.Model.ProductCategory", "Parent")
                        .WithMany("Children")
