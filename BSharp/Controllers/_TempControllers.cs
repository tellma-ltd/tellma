...
namespace BSharp.Controllers
{
    ...
    [ApplicationApi]
    public class IfrsEntryClassificationsController : ReadEntitiesControllerBase<IfrsEntryClassification, string>
    {
    ...
    [ApplicationApi]
    public class IfrsAccountClassificationsController : ReadEntitiesControllerBase<IfrsAccountClassification, string>
    {
        private readonly ApplicationRepository _repo;
    ...
    [ApplicationApi]
    public class VoucherBookletsController : ReadEntitiesControllerBase<VoucherBooklet, int>
    {
        private readonly ApplicationRepository _repo;
