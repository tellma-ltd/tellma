...
export class AppConfig {
    apiAddress = environment.production ? (window.location.origin.replace('http://', 'https://') + '/') : 'https://localhost:44368/';
    identityAddress = environment.production ? window.location.origin.replace('http://', 'https://') : 'https://localhost:44368';
