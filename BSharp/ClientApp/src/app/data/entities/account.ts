    ...
    if (ws.settings !== _settings) {
        ...
        const entityDesc: EntityDescriptor = {
            ...
            properties: {
                ...
                EntryClassificationId: { control: 'number', label: () => `${trx.instant('Account_EntryType')} (${trx.instant('Id')})`, minDecimalPlaces: 0, maxDecimalPlaces: 0 },
                EntryClassification: { control: 'navigation', label: () => trx.instant('Account_EntryType'), type: 'EntryClassification', foreignKeyName: 'EntryClassificationId' },
