...
@Component({
  selector: 'b-error-loading-settings',
  templateUrl: './error-loading-settings.component.html',
  styleUrls: ['./error-loading-settings.component.scss']
})
export class ErrorLoadingSettingsComponent implements OnInit {
